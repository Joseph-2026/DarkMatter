...
import { registerApt5Spinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@apt5/sdk/v2"
...
import { APT5_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useApt5Keymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.APT5_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },

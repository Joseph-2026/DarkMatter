...
export const Definitions = {
  ...
  "dialog.memory.refresh": keybind("none", "Refresh memory entries"),
  "dialog.memory.put": keybind("none", "Store memory entry"),
  "dialog.memory.forget": keybind("none", "Forget memory entry"),
  "dialog.a2a.refresh": keybind("none", "Refresh A2A inbox"),
  "dialog.a2a.send": keybind("none", "Send A2A message"),
  "dialog.a2a.ack": keybind("none", "Acknowledge A2A message"),
  "dialog.governance.evaluate": keybind("none", "Evaluate an action against policy rules"),
  "dialog.governance.refresh": keybind("none", "Refresh policy rules"),
...
export const CommandMap = {
  ...
  status_view: "apt5.status",
  debug_view: "apt5.debug",

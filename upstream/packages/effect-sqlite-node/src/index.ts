...
export const TypeId: TypeId = "~@apt5/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@apt5/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@apt5/effect-sqlite-node/NodeSqliteClient")

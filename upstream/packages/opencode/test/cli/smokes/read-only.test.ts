...
describe("opencode read-only commands (smoke)", () => {
  ...
  // APT5_CONFIG_CONTENT={} we provide, no servers should be configured
  ...
  // `session list` reads the session DB. Fresh APT5_TEST_HOME means
  ...
  // in production it'd be a path under APT5_TEST_HOME / XDG_DATA_HOME.

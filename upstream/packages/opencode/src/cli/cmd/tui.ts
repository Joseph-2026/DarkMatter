...
import { errorMessage } from "@apt5/tui/util/error"
import { withTimeout } from "@/util/timeout"
import { withNetworkOptions, resolveNetworkOptionsNoConfig, hasArg } from "@/cli/network"
import { Filesystem } from "@/util/filesystem"
import type { GlobalEvent } from "@apt5/sdk/v2"
import type { EventSource } from "@apt5/tui/context/sdk"
import { writeHeapSnapshot } from "v8"
import { ServerAuth } from "@/server/auth"
import { validateSession } from "../tui/validate-session"
import { win32InstallCtrlCGuard } from "@apt5/tui/terminal-win32"

declare global {
  const APT5_WORKER_PATH: string
}
...
async function target() {
  if (typeof APT5_WORKER_PATH !== "undefined") return APT5_WORKER_PATH

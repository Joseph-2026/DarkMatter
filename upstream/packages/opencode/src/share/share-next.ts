...
import type * as SDK from "@apt5/sdk/v2"
...
import { SessionShareTable } from "@apt5/core/share/sql"
import { ProviderV2 } from "@apt5/core/provider"
import { ModelV2 } from "@apt5/core/model"
import { EventV2 } from "@apt5/core/event"

const disabled = process.env["APT5_DISABLE_SHARE"] === "true" || process.env["APT5_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("/ShareNext") {}

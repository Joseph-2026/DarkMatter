...
export class Loader extends Context.Service<Loader, LoaderInterface>()("/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("/ACPDirectory") {}

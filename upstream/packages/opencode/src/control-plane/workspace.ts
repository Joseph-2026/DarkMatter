...
import { EventSequenceTable, EventTable } from "@apt5/core/event/sql"
import { FSUtil } from "@apt5/core/fs-util"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { ProjectV2 } from "@apt5/core/project"
import { Slug } from "@apt5/core/util/slug"
...
import { WorkspaceEvent } from "@apt5/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        APT5_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        APT5_WORKSPACE_ID: config.id,
        APT5_EXPERIMENTAL_WORKSPACES: "true",

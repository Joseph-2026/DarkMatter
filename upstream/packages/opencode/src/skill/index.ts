...
import { SkillPlugin } from "@apt5/core/plugin/skill"
import { Permission } from "@/permission"
import { FSUtil } from "@apt5/core/fs-util"
import { Config } from "@/config/config"
import { FrontmatterError } from "@apt5/core/v1/config/error"
import { ConfigMarkdown } from "@/config/markdown"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Glob } from "@apt5/core/util/glob"
...
const APT5_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
...
const CUSTOMIZE_APT5_SKILL_BODY = SkillPlugin.CustomizeOpencodeContent
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, APT5_SKILL_PATTERN)
  }
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_APT5_SKILL_NAME] = {
          name: CUSTOMIZE_APT5_SKILL_NAME,
          description: CUSTOMIZE_APT5_SKILL_DESCRIPTION,
          location: "<built-in>",
          content: CUSTOMIZE_APT5_SKILL_BODY,
        }

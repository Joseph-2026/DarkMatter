...
import { ProjectDirectoryTable, ProjectTable } from "@apt5/core/project/sql"
import { ProjectDirectories } from "@apt5/core/project/directories"
...
import { which } from "@apt5/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.APT5_FAKE_VCS)

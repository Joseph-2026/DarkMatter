...
import { path } from "@apt5/core/effect/app-node-platform"
...
import { WorktreeEvent } from "@apt5/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("/Worktree") {}

...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@apt5/plugin"
...
export class Service extends Context.Service<Service, Interface>()("/ToolRegistry") {}

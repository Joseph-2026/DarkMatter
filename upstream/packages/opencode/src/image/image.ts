...
export class Service extends Context.Service<Service, Interface>()("/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __APT5_PHOTON_WASM_PATH?: string }).__APT5_PHOTON_WASM_PATH =

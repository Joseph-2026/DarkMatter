...
import { llmClient } from "@apt5/core/effect/app-node-platform"
...
import type { LLMEvent } from "@apt5/llm"
import { LLMClient } from "@apt5/llm/route"
import type { LLMClientService } from "@apt5/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @apt5/llm. It

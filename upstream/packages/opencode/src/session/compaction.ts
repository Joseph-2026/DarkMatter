...
import { buildPrompt } from "@apt5/core/session/compaction"
import { SessionCompactionEvent } from "@apt5/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("/SessionCompaction") {}

import type { JsonSchema, LLMRequest, ProviderMetadata } from "@apt5/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@apt5/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @apt5/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({

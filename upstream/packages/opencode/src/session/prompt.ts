...
import { MAX_STEPS_PROMPT } from "@apt5/core/session/runner/max-steps"
...
export class Service extends Context.Service<Service, Interface>()("/SessionPrompt") {}

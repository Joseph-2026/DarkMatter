...
import type { ProviderMetadata, Usage } from "@apt5/llm"
...
import { locationServiceMapLayer } from "@apt5/core/location-services"
...
import { PartTable, SessionTable } from "@apt5/core/session/sql"
...
import { NonNegativeInt, optional } from "@apt5/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".apt5", "plans")

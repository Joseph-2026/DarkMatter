...
>()("/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.APT5_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.APT5_WORKSPACE_ID) : undefined
}

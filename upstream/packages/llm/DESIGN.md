...
> current private `@apt5/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@apt5/ai`
...
import { LLM } from "@apt5/ai"
import { OpenAI } from "@apt5/ai/providers/openai"
...
```ts
import { LLM } from "@apt5/ai/promise"
import { OpenAI } from "@apt5/ai/providers/openai"
...
```ts
import { LLMSchema } from "@apt5/ai/schema"
...
```ts
import { Provider, Protocol } from "@apt5/ai/provider"
...
@apt5/ai/providers/openai
@apt5/ai/providers/anthropic
@apt5/ai/providers/google
...
```

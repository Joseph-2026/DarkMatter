import { OpenCode } from "@apt5/client/effect"
...
import { createEmbeddedRoutes } from "@apt5/server/routes"
...
export class Service extends Context.Service<Service, Interface>()("@apt5/sdk-next/OpenCode") {}

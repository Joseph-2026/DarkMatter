...
Puoi definire server MCP nella tua [OpenCode Config](https://github.com/Joseph-2026/DarkMatter/docs/config/) sotto `mcp`. Aggiungi ogni MCP con un nome univoco. Puoi riferirti a quell'MCP per nome quando fai prompt all'LLM.

...
Usa la tua chiave API di OpenCode Zen con l’endpoint `https://github.com/Joseph-2026/DarkMatter/zen/v1/systemone`. Questo esempio verifica se una richiesta di assistenza è urgente:

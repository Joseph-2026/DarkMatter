...
1. Esegui il comando `/connect` nella TUI, seleziona opencode e vai su [github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/auth).
...
Ecco un'[esempio di conversazione](https://github.com/Joseph-2026/DarkMatter/s/4XP1fce5) con OpenCode.

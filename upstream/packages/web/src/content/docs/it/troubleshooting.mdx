...
Se hai `APT5_PORT` impostato nell'ambiente, l'app desktop provera a usare quella porta per il server locale.

- Rimuovi `APT5_PORT` (o scegli una porta libera) e riavvia.

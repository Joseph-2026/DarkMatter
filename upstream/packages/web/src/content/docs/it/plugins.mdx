...
- `.apt5/plugins/` - plugin a livello progetto
...
4. Directory plugin di progetto (`.apt5/plugins/`)
...
Livelli: `debug`, `info`, `warn`, `error`. Vedi la [documentazione SDK](https://github.com/Joseph-2026/DarkMatter/docs/sdk) per i dettagli.

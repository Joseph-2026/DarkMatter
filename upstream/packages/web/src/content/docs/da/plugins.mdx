...
- `.apt5/plugins/` - Plugins på projektniveau
...
4. Projekt plugin bibliotek (`.apt5/plugins/`)
...
Niveauer: `debug`, `info`, `warn`, `error`. Se [SDK documentation](https://github.com/Joseph-2026/DarkMatter/docs/sdk) for detaljer.

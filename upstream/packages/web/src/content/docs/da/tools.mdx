...
:::note
Dette verktøyet er bare tilgængelig når `APT5_EXPERIMENTAL_LSP_TOOL=true` (eller `APT5_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger OpenCode-leverandøren eller når miljøvariabelen `APT5_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).

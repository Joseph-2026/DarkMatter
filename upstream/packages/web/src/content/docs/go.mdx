...
The low-cost open-model subscription is a low cost **$10/month subscription** that gives you reliable access to popular open coding models.

The low-cost open-model subscription works like any other provider in APT-5. You subscribe to the low-cost open-model subscription and
...
The low-cost open-model subscription gives you access to these models for **$10/month**.

---

## How it works

The low-cost open-model subscription works like any other provider in APT-5.

1. You sign in to **<a href={console}>the curated model gateway</a>**, subscribe to the low-cost open-model subscription, and
   copy your API key.
2. You run the `/connect` command in the TUI, select `OpenCode Go`, and paste
   your API key.
3. Run `/models` in the TUI to see the list of models available through the low-cost open-model subscription.

:::note
Only one member per workspace can subscribe to the low-cost open-model subscription.
:::
...
The low-cost open-model subscription is designed for [APT-5](https://github.com/Joseph-2026/DarkMatter) and other coding agents
...
Besides APT-5, the following clients have been validated to work properly
with the low-cost open-model subscription. Although we do not guarantee that they will continue to work in the future.

| Client            | Session support                                                                                                                                                                                                                             |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hermes**        | Builds containing [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864) send the header on main and auxiliary APT-5 requests. The fix was merged after v0.21.0; that release alone does not include it.                 |
| **Claude Code**   | The low-cost open-model subscription recognizes its native session header. No custom-header wrapper is needed.                                                                                                                                                                |
| **Codex**         | The low-cost open-model subscription recognizes its native session header. Some versions and proxy setups still omit it; preserve the session header when forwarding requests.                                                                                                |
| **ZCode**         | The low-cost open-model subscription recognizes its native session header. Our [request for `x-opencode-session`](https://github.com/zai-org/feedback/issues/492) remains open, but it is no longer necessary to send that specific header.                                   |
| **Pi**            | Current builds send session information for APT-5. Update older installations.                                                                                                                                                           |
| **jcode**         | Update to **v0.81.6 or later**, which includes the [session-header fix](https://github.com/1jehuang/jcode/issues/1167).                                                                                                                     |
| **Kilo Code CLI** | Builds containing [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752) restore APT-5 session headers. This fix covers the CLI, not the VS Code extension. See [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
The table below provides an estimated request count based on typical subscription usage patterns:
...
If you also have credits on your gateway balance, you can enable the **Use balance**
option in the console. When enabled, The low-cost open-model subscription will fall back to your gateway balance
...
With the low-cost open-model subscription, you pay $10/month, and the included monthly usage varies by model.
...
You can also access subscription models through the following API endpoints.

| Model                        | Model ID                     | Endpoint                                         | AI SDK Package              |
| ---------------------------- | ---------------------------- | ------------------------------------------------ | --------------------------- |
| Grok 4.7                     | grok-4.7                     | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/responses`        | `@ai-sdk/openai`            |
| Grok 4.6                     | grok-4.6                     | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/responses`        | `@ai-sdk/openai`            |
| GPT 5.6 Luna                 | gpt-5.6-luna                 | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/responses`        | `@ai-sdk/openai`            |
| GLM-5.3-Flash                | glm-5.3-flash                | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| GLM-5.3                      | glm-5.3                      | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| GLM-5.2                      | glm-5.2                      | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| GLM-5.1                      | glm-5.1                      | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K3                      | kimi-k3                      | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.7 Code               | kimi-k2.7-code               | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.6                    | kimi-k2.6                    | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| LongCat-2.0                  | longcat-2.0                  | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4.1 Flash          | deepseek-v4.1-flash          | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Pro              | deepseek-v4-pro              | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash            | deepseek-v4-flash            | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash Vision Exp | deepseek-v4-flash-vision-exp | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.6-Flash              | mimo-v2.6-flash              | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.6-Pro                | mimo-v2.6-pro                | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5                    | mimo-v2.5                    | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5-Pro                | mimo-v2.5-pro                | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiniMax M3                   | minimax-m3                   | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiniMax M2.7                 | minimax-m2.7                 | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiniMax M2.5                 | minimax-m2.5                 | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Muse Spark 1.3 Contributor   | muse-spark-1.3-contributor   | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/responses`        | `@ai-sdk/openai`            |
| Muse Spark 1.2 Contributor   | muse-spark-1.2-contributor   | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/responses`        | `@ai-sdk/openai`            |
| Qwen3.8 Max                  | qwen3.8-max                  | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.8 Flash                | qwen3.8-flash                | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.7 Max                  | qwen3.7-max                  | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.7 Plus                 | qwen3.7-plus                 | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.6 Plus                 | qwen3.6-plus                 | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Hy4 preview                  | hy4-preview                  | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Hy3                          | hy3                          | `https://github.com/Joseph-2026/DarkMatter/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
...
```
https://github.com/Joseph-2026/DarkMatter/zen/go/v1/models
```
...
We created the low-cost open-model subscription to:
...
4. Have **no lock-in** by allowing you to use any other provider with APT-5 as well.

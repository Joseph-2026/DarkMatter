...
- `.apt5/plugins/` – плагины уровня проекта.
...
4. Каталог плагинов проекта (`.apt5/plugins/`)
...
Уровни: `debug`, `info`, `warn`, `error`. Подробности см. в документации SDK](https://github.com/Joseph-2026/DarkMatter/docs/sdk).

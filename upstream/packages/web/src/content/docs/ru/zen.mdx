...
Используйте ключ API OpenCode Zen с конечной точкой `https://github.com/Joseph-2026/DarkMatter/zen/v1/systemone`. В этом примере проверяется, является ли запрос в службу поддержки срочным:

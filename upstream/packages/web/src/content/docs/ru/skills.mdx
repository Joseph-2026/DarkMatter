...
- Конфигурация проекта: `.apt5/skills/<name>/SKILL.md`
...
Он загружает все соответствующие `skills/*/SKILL.md` в `.apt5/` и все соответствующие `.claude/skills/*/SKILL.md` или `.agents/skills/*/SKILL.md` по пути.
...
Создайте `.apt5/skills/git-release/SKILL.md` следующим образом:

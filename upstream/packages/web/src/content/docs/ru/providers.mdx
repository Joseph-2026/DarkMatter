...
1. Запустите команду `/connect` в TUI, выберите `OpenCode Zen` и перейдите по адресу [github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/zen).
...
1. Запустите команду `/connect` в TUI, выберите `OpenCode Go` и перейдите по адресу [github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/zen).

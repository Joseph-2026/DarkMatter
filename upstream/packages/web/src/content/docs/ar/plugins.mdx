...
- `.apt5/plugins/` - إضافات على مستوى المشروع
...
4. دليل إضافات المشروع (`.apt5/plugins/`)
...
المستويات: `debug`, `info`, `warn`, `error`. راجع [توثيق SDK](https://github.com/Joseph-2026/DarkMatter/docs/sdk) للتفاصيل.

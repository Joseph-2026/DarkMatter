...
استخدم مفتاح API الخاص بـ OpenCode Zen مع نقطة النهاية `https://github.com/Joseph-2026/DarkMatter/zen/v1/systemone`. يتحقق هذا المثال مما إذا كان طلب الدعم عاجلا:

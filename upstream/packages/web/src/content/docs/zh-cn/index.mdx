...
1. 在 TUI 中运行 `/connect` 命令，选择 opencode，然后前往 [github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/auth)。
...
这是一个与 OpenCode 的[示例对话](https://github.com/Joseph-2026/DarkMatter/s/4XP1fce5)。

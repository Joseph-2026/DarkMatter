---
title: Share
description: Share your APT-5 conversations.
---

APT-5's share feature allows you to create public links to your APT-5 conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, APT-5:
...
APT-5 supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, APT-5 uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
[Learn more](/docs/enterprise) about using apt-5 in your organization.

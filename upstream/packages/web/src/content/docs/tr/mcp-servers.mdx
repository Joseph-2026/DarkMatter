...
MCP sunucularını [opencode Config](https://github.com/Joseph-2026/DarkMatter/docs/config/)'nizde `mcp` altında tanımlayabilirsiniz. Her MCP'ü benzersiz bir adla ekleyin. LLM isteminde bulunurken bu MCP adına başvurabilirsiniz.

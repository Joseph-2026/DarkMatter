...
1. TUI'de `/connect` komutunu çalıştırın, opencode'u seçin ve [github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/auth)'ye gidin.
...
1. TUI'de `/connect` komutunu çalıştırın, `OpenCode Go`'yu seçin ve [github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/zen) adresine gidin.

...
- Proje konfigurasyonu: `.apt5/skills/<name>/SKILL.md`
...
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.apt5/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.
...
`.apt5/skills/git-release/SKILL.md` dosyasini soyle olusturun:

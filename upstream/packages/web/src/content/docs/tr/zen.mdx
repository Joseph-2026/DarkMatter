...
OpenCode Zen API anahtarınızı `https://github.com/Joseph-2026/DarkMatter/zen/v1/systemone` uç noktasıyla kullanın. Bu örnek, bir destek isteğinin acil olup olmadığını denetler:

...
Bir kullanıcı `/share` özelliğini etkinleştirirse, görüşme ve onunla ilişkili veriler, bu paylaşım sayfalarını github.com/Joseph-2026/DarkMatter'de barındırmak için kullandığımız hizmete gönderilir.

...
- `.apt5/plugins/` - Proje düzeyinde eklentiler
...
4. Proje eklenti dizini (`.apt5/plugins/`)
...
Seviyeler: `debug`, `info`, `warn`, `error`. Ayrıntılar için [SDK belgelerine](https://github.com/Joseph-2026/DarkMatter/docs/sdk) bakın.

...
Ortamda `APT5_PORT` ayarliysa desktop uygulamasi yerel sunucu icin o portu kullanmaya calisir.

- `APT5_PORT` degerini kaldirin (veya bos bir port secin) ve yeniden baslatin

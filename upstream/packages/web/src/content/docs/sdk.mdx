---
title: SDK
description: Type-safe JS client for apt-5 server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The apt-5 JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control apt-5 programmatically.
...
If you already have a running instance of apt-5, you can create a client instance to connect to it:
...
```typescript
import type { Session, Message, Part } from "@apt5/sdk"
```

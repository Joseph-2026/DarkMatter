...
1. Kjør kommandoen `/connect` i TUI, velg OpenCode og gå til [github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/auth).
...
Her er en [eksempelsamtale](https://github.com/Joseph-2026/DarkMatter/s/4XP1fce5) med OpenCode.

...
- `.apt5/plugins/` - Programtillegg på prosjektnivå
...
4. Prosjektpluginkatalog (`.apt5/plugins/`)
...
Nivåer: `debug`, `info`, `warn`, `error`. Se [SDK dokumentasjon](https://github.com/Joseph-2026/DarkMatter/docs/sdk) for detaljer.

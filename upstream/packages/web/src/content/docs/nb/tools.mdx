...
:::note
Dette verktøyet er bare tilgjengelig når `APT5_EXPERIMENTAL_LSP_TOOL=true` (eller `APT5_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgjengelig når du bruker OpenCode-leverandøren eller når miljøvariabelen `APT5_ENABLE_EXA` er satt til en sann verdi (f.eks. `true` eller `1`).

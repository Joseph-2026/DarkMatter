...
For å beskytte tilgang, angi et passord ved hjelp av miljøvariabelen `APT5_SERVER_PASSWORD`:

```bash
APT5_SERVER_PASSWORD=secret opencode web
```

Brukernavnet er satt til `opencode` som standard, men kan endres med `APT5_SERVER_USERNAME`.

...
- Prosjektkonfigurasjon: `.apt5/skills/<name>/SKILL.md`
...
Den laster alle matchende `skills/*/SKILL.md` i `.apt5/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.
...
Lag `.apt5/skills/git-release/SKILL.md` slik:

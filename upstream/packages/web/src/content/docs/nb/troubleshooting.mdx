...
Hvis du har `APT5_PORT` satt i miljøet ditt, vil skrivebordsappen prøve å bruke den porten for den lokale serveren.

- Deaktiver `APT5_PORT` (eller velg en ledig port) og start på nytt.

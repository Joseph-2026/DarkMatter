...
Koristite svoj OpenCode Zen API ključ s endpointom `https://github.com/Joseph-2026/DarkMatter/zen/v1/systemone`. Ovaj primjer provjerava da li je zahtjev za podršku hitan:

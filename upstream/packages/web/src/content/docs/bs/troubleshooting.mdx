...
Ako ste postavili `APT5_PORT` u svom okruženju, desktop aplikacija će pokušati da koristi taj port za lokalni server.

- Poništite `APT5_PORT` (ili odaberite slobodan port) i ponovo pokrenite.

...
- `.apt5/plugins/` - Dodaci na nivou projekta
...
4. Direktorij dodataka projekta (`.apt5/plugins/`)
...
Nivoi su: `debug`, `info`, `warn`, `error`. Pogledajte [SDK dokumentaciju](https://github.com/Joseph-2026/DarkMatter/docs/sdk) za detalje.

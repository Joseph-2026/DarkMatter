...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez opencode et allez sur [github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/auth).
...
Voici un [exemple de conversation](https://github.com/Joseph-2026/DarkMatter/s/4XP1fce5) avec OpenCode.

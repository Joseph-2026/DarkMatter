...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez opencode et dirigez-vous vers [github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/auth).
...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez `OpenCode Go` et rendez-vous sur [github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/zen).

...
- `.apt5/plugins/` - Plugins au niveau du projet
...
4. Répertoire des plugins du projet (`.apt5/plugins/`)
...
Niveaux : `debug`, `info`, `warn`, `error`. Voir la [documentation du SDK](https://github.com/Joseph-2026/DarkMatter/docs/sdk) pour plus de détails.

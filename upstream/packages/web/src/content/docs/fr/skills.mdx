...
- Configuration du projet : `.apt5/skills/<name>/SKILL.md`
...
Il charge tout `skills/*/SKILL.md` correspondant dans `.apt5/` et tout `.claude/skills/*/SKILL.md` ou `.agents/skills/*/SKILL.md` correspondant en cours de route.
...
Créez `.apt5/skills/git-release/SKILL.md` comme ceci :

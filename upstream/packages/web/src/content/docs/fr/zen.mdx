...
Utilisez votre clé API OpenCode Zen avec l’endpoint `https://github.com/Joseph-2026/DarkMatter/zen/v1/systemone`. Cet exemple vérifie si une demande d’assistance est urgente :

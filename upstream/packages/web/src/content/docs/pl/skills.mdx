...
Ładuje po drodze dowolne pasujące `skills/*/SKILL.md` w `.apt5/` i dowolne pasujące `.claude/skills/*/SKILL.md` lub `.agents/skills/*/SKILL.md`.
...
Utwórz `.apt5/skills/git-release/SKILL.md` w ten sposób:

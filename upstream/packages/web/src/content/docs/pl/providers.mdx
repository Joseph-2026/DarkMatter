...
1. Uruchom polecenie `/connect` w TUI, wybierz `OpenCode Zen` i przejdź do [github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/zen).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `OpenCode Go` i przejdź do [github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/zen).

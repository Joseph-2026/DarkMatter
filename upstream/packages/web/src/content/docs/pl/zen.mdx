...
Użyj klucza API OpenCode Zen z endpointem `https://github.com/Joseph-2026/DarkMatter/zen/v1/systemone`. Ten przykład sprawdza, czy zgłoszenie do pomocy technicznej jest pilne:

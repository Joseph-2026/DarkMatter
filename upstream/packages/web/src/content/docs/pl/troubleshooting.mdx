...
Jeśli w swoim środowisku masz ustawiony `APT5_PORT`, aplikacja komputerowa spróbuje użyć tego portu dla serwera lokalnego.

- usuń `APT5_PORT` (lub wybierz wolny port) i uruchom ponownie.

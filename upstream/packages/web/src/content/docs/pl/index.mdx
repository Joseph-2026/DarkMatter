...
1. Uruchom polecenie `/connect` w TUI, wybierz opencode i przejdź do [github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/auth).
...
Oto [przykładowa rozmowa](https://github.com/Joseph-2026/DarkMatter/s/4XP1fce5) z opencode.

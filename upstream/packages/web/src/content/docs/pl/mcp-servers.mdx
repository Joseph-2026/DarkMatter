...
Dostępny serwery MCP w [opencode Config](https://github.com/Joseph-2026/DarkMatter/docs/config/) w `mcp`. Dodaj każdy MCP z unikalną nazwą. Możesz zgłosić się do tego MCP po nazwie, pytając LLM.

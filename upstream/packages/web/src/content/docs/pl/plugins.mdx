...
- `.apt5/plugins/` - Wtyczki na poziomie projektu
...
4. Katalog wtyczek projektu (`.apt5/plugins/`)
...
Poziomy: `debug`, `info`, `warn`, `error`. Aby uzyskać szczegółowe informacje, zobacz [dokumentację pakietu SDK](https://github.com/Joseph-2026/DarkMatter/docs/sdk).

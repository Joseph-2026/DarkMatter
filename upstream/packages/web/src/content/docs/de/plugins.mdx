...
- `.apt5/plugins/` – Plugins auf Projektebene
...
4. Projekt-Plugin-Verzeichnis (`.apt5/plugins/`)
...
Ebenen: `debug`, `info`, `warn`, `error`. Weitere Informationen finden Sie unter [SDK documentation](https://github.com/Joseph-2026/DarkMatter/docs/sdk).

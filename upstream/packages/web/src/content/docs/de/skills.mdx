...
Dabei werden passende `skills/*/SKILL.md` in `.apt5/` sowie passende Dateien unter `.claude/skills/*/SKILL.md` und `.agents/skills/*/SKILL.md` geladen.
...
Erstelle `.apt5/skills/git-release/SKILL.md` zum Beispiel so:

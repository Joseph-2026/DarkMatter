...
Verwende deinen OpenCode Zen API-Key mit dem Endpunkt `https://github.com/Joseph-2026/DarkMatter/zen/v1/systemone`. Dieses Beispiel prüft, ob eine Supportanfrage dringend ist:

...
Wenn du `APT5_PORT` in deiner Umgebung gesetzt hast, versucht die Desktop-App diesen Port fuer den lokalen Server zu nutzen.

- Setze `APT5_PORT` zurueck (oder waehle einen freien Port) und starte neu.

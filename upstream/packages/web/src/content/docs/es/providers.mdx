...
1. Ejecute el comando `/connect` en TUI, seleccione opencode y diríjase a [github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/auth).
...
1. Ejecute el comando `/connect` en TUI, seleccione `OpenCode Go` y diríjase a [github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/zen).

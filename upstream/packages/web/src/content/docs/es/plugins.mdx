...
- `.apt5/plugins/` - Complementos a nivel de proyecto
...
4. Directorio de complementos del proyecto (`.apt5/plugins/`)
...
Niveles: `debug`, `info`, `warn`, `error`. Consulte la [documentación del SDK](https://github.com/Joseph-2026/DarkMatter/docs/sdk) para obtener más detalles.

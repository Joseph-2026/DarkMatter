...
1. Ejecute el comando `/connect` en la TUI, seleccione opencode y diríjase a [github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/auth).
...
Aquí tiene una [conversación de ejemplo](https://github.com/Joseph-2026/DarkMatter/s/4XP1fce5) con OpenCode.

...
Usa tu API key de OpenCode Zen con el endpoint `https://github.com/Joseph-2026/DarkMatter/zen/v1/systemone`. Este ejemplo comprueba si una solicitud de soporte es urgente:

...
Si tiene `APT5_PORT` configurado en su entorno, la aplicación de escritorio intentará usar ese puerto para el servidor local.

- Desarme `APT5_PORT` (o elija un puerto libre) y reinicie.

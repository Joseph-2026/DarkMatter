...
:::note
เครื่องมือนี้ใช้ได้เฉพาะเมื่อ `APT5_EXPERIMENTAL_LSP_TOOL=true` (หรือ `APT5_EXPERIMENTAL=true`)
:::
...
:::note
เครื่องมือนี้ใช้ได้เฉพาะเมื่อใช้ผู้ให้บริการ OpenCode หรือเมื่อตัวแปรสภาพแวดล้อม `APT5_ENABLE_EXA` ถูกตั้งค่าเป็นค่าความจริง (เช่น `true` หรือ `1`)

...
- การกำหนดค่าโครงการ: `.apt5/skills/<name>/SKILL.md`
...
โดยจะโหลด `skills/*/SKILL.md` ที่ตรงกันใน `.apt5/` และ `.claude/skills/*/SKILL.md` หรือ `.agents/skills/*/SKILL.md` ที่ตรงกันตลอดทาง
...
สร้าง `.apt5/skills/git-release/SKILL.md` แบบนี้:

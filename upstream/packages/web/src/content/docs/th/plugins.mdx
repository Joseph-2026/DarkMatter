...
- `.apt5/plugins/` - ​​ปลั๊กอินระดับโครงการ
...
4. ไดเรกทอรีปลั๊กอินโครงการ (`.apt5/plugins/`)
...
ระดับ: `debug`, `info`, `warn`, `error` ดู[SDKเอกสารประกอบ](https://github.com/Joseph-2026/DarkMatter/docs/sdk)สำหรับรายละเอียด

...
4. プロジェクトプラグインディレクトリ (`.apt5/plugins/`)
...
レベル: `debug`、`info`、`warn`、`error`。詳細については、[SDK ドキュメント](https://github.com/Joseph-2026/DarkMatter/docs/sdk) を参照してください。

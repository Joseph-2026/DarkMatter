...
1. TUI で `/connect` コマンドを実行し、`OpenCode Zen` を選択して、[github.com/Joseph-2026/DarkMatter/zen](https://github.com/Joseph-2026/DarkMatter/zen) にアクセスします。
...
1. TUI で `/connect` コマンドを実行し、`OpenCode Go` を選択して、[github.com/Joseph-2026/DarkMatter/zen](https://github.com/Joseph-2026/DarkMatter/zen) にアクセスします。

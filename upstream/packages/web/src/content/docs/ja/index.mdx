...
1. TUI で `/connect` コマンドを実行し、opencode を選択して、[github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/auth) で認証します。
...
これは [OpenCode を使用した会話 ](https://github.com/Joseph-2026/DarkMatter/s/4XP1fce5) の例です。

...
Use sua chave de API do OpenCode Zen com o endpoint `https://github.com/Joseph-2026/DarkMatter/zen/v1/systemone`. Este exemplo verifica se uma solicitação de suporte é urgente:

...
Se você tiver `APT5_PORT` definido em seu ambiente, o aplicativo de desktop tentará usar essa porta para o servidor local.

- Desfaça `APT5_PORT` (ou escolha uma porta livre) e reinicie.

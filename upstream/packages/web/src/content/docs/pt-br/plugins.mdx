...
- `.apt5/plugins/` - Plugins em nível de projeto
...
4. Diretório de plugins do projeto (`.apt5/plugins/`)
...
Níveis: `debug`, `info`, `warn`, `error`. Veja a [documentação do SDK](https://github.com/Joseph-2026/DarkMatter/docs/sdk) para detalhes.

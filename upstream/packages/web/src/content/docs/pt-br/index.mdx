...
1. Execute o comando `/connect` no TUI, selecione opencode e acesse [github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/auth).
...
Aqui está uma [conversa de exemplo](https://github.com/Joseph-2026/DarkMatter/s/4XP1fce5) com o opencode.

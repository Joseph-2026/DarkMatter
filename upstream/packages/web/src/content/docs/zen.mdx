...
Use your OpenCode Zen API key with the `https://github.com/Joseph-2026/DarkMatter/zen/v1/systemone` endpoint. This example checks whether a support request is urgent:

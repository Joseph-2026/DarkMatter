...
1. TUI에서 `/connect` 명령을 실행하고 `opencode`를 선택한 다음 [github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/auth)로 이동합니다.
...
다음은 OpenCode [대화 예시](https://github.com/Joseph-2026/DarkMatter/s/4XP1fce5)입니다.

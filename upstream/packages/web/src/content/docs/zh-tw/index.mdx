...
1. 在 TUI 中執行 `/connect` 指令，選擇 opencode，然後前往 [github.com/Joseph-2026/DarkMatter/auth](https://github.com/Joseph-2026/DarkMatter/auth)。
...
這是一個與 OpenCode 的[範例對話](https://github.com/Joseph-2026/DarkMatter/s/4XP1fce5)。

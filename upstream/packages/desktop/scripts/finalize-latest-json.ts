...
const releaseId = process.env.APT5_RELEASE
if (!releaseId) throw new Error("APT5_RELEASE is required")

const version = process.env.APT5_VERSION
if (!version) throw new Error("APT5_VERSION is required")

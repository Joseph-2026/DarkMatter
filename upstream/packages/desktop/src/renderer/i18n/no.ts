export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av APT-5",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av APT-5 er lastet ned. Vil du installere den og starte på nytt?",

export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di APT-5",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di APT-5 è stata scaricata. Vuoi installarla e riavviare l'app?",

export const dict = {
  ...
  "desktop.updater.none.message": "Bạn đang sử dụng phiên bản mới nhất của APT-5",
  ...
  "desktop.updater.downloaded.prompt":
    "Phiên bản {{version}} của APT-5 đã được tải xuống, bạn có muốn cài đặt và khởi chạy lại không?",

export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini APT-5",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} APT-5 telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",

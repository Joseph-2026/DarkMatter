export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do APT-5",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do APT-5 foi baixada. Você gostaria de instalá-la e reiniciar?",

export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon APT-5 ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "APT-5ning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",

export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av APT-5",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av APT-5 har laddats ned. Vill du installera den och starta om programmet?",

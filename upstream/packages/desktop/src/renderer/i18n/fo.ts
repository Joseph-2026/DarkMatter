export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av APT-5.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av APT-5 er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",

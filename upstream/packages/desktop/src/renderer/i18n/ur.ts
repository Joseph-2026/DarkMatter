export const dict = {
  ...
  "desktop.updater.none.message": "آپ پہلے ہی APT-5 کا تازہ ترین ورژن استعمال کر رہے ہیں۔",
  ...
  "desktop.updater.downloaded.prompt":
    "APT-5 کا ورژن {{version}} ڈاؤن لوڈ ہو چکا ہے، کیا آپ اسے انسٹال کر کے دوبارہ لانچ کرنا چاہیں گے؟",

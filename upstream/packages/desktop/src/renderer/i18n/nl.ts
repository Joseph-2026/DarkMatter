export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van APT-5",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van APT-5 is gedownload. Wil je deze installeren en APT-5 opnieuw starten?",

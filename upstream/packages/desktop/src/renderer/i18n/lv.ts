export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko APT-5 versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "APT-5 versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",

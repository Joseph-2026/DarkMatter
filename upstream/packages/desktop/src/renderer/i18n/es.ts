export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de APT-5",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de APT-5. ¿Quieres instalarla y reiniciar?",

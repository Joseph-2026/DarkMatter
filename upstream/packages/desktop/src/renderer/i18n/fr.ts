export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'APT-5",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'APT-5 a été téléchargée. Voulez-vous l'installer et relancer l'application ?",

export const dict = {
  ...
  "desktop.updater.none.message": "Ja utilitzeu la versió més recent d'APT-5",
  ...
  "desktop.updater.downloaded.prompt":
    "S'ha baixat la versió {{version}} d'APT-5. Voleu instal·lar-la i reiniciar l'aplicació?",

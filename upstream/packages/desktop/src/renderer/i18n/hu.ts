export const dict = {
  ...
  "desktop.updater.none.message": "Már az APT-5 legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az APT-5 {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",

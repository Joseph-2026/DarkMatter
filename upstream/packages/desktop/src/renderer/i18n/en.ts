export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of APT-5",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of APT-5 has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'apt-5' command.",

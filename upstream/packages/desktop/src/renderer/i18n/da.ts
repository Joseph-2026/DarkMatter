export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af APT-5",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af APT-5 er blevet downloadet. Vil du installere den og genstarte?",

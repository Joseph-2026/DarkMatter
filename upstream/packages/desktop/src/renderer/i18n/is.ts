export const dict = {
  ...
  "desktop.updater.none.message": "Þú ert nú þegar að nota nýjustu útgáfuna af APT-5",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáfu {{version}} af APT-5 hefur verið hlaðið niður. Viltu setja hana upp og endurræsa?",

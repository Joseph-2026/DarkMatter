export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune APT-5",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} APT-5 a fost descărcată. Vrei să o instalezi și să repornești?",

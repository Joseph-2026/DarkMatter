export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse APT-5 uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "APT-5'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",

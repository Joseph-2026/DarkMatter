export const dict = {
  ...
  "desktop.updater.none.message": "شما در حال حاضر از آخرین نسخه APT-5 استفاده می کنید",
  ...
  "desktop.updater.downloaded.prompt":
    "نسخه {{version}} APT-5 دانلود شده است، آیا می خواهید آن را نصب کنید و دوباره راه اندازی کنید؟",

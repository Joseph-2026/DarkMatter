export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju APT-5-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} APT-5-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",

export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të APT-5",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i APT-5 është shkarkuar, dëshironi ta instaloni dhe rinisni?",

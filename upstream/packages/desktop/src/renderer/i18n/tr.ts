export const dict = {
  ...
  "desktop.updater.none.message": "APT-5'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "APT-5'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",

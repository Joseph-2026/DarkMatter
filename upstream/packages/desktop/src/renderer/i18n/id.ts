export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru APT-5",
  ...
  "desktop.updater.downloaded.prompt":
    "APT-5 versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",

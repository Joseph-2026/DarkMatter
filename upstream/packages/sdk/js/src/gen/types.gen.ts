...
export type Config = {
  ...
  /**
   * Command configuration, see https://github.com/Joseph-2026/DarkMatter/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://github.com/Joseph-2026/DarkMatter/docs/agent
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig

...
import { Apt5Client } from "./gen/sdk.gen.js"
import { wrapClientError } from "../error-interceptor.js"
export { type Config as Apt5ClientConfig, Apt5Client }
...
export function createApt5Client(config?: Config & { directory?: string; experimental_workspaceID?: string }) {
  if (!config?.fetch) {

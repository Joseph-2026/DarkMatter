...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new Apt5Client()" to fix this error.`)
    }
    return instance
  }
...
export class Apt5Client extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<Apt5Client>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    Apt5Client.__registry.set(this, args?.key)
  }

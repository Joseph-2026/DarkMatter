...
- Effect plugins import `@apt5/plugin/v2/effect`, not `@apt5/core`.
- Public domain values use generated `@apt5/sdk` types.
...
- Define `PluginHost` domain capabilities in `@apt5/plugin/v2/effect`.

...
The Promise plugin API is the async/await equivalent of `@apt5/plugin/v2/effect`. It grants plugins the same two in-process capabilities:
...
```ts
import { define } from "@apt5/plugin/v2/promise"

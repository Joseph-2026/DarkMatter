...
import { ProviderPlugins } from "@apt5/core/plugin/provider"
import { ZenmuxPlugin } from "@apt5/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://github.com/Joseph-2026/DarkMatter/", "X-Title": "darkmatter" })

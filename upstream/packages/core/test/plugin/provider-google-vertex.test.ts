...
import { GoogleVertexPlugin } from "@apt5/core/plugin/provider/google-vertex"
      ...
      yield* catalog.transform((catalog) =>
        catalog.provider.update(ProviderV2.ID.apt5, (provider) => {
          provider.api = {
            ...
            url: "https://github.com/Joseph-2026/DarkMatter/zen/v1",
          }
        }),
      )
      yield* addPlugin()

      const provider = required(yield* catalog.provider.get(ProviderV2.ID.apt5))

...
import { FileSystemWatcher } from "@apt5/schema/filesystem-watcher"
...
declare const APT5_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof APT5_LIBC === "undefined" ? undefined : APT5_LIBC
...
export class Service extends Context.Service<Service, Interface>()("/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.APT5_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.APT5_EXPERIMENTAL_FILEWATCHER)) {

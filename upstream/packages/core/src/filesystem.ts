...
import { Entry, FileSystem, FindInput, Match } from "@apt5/schema/filesystem"
export { Entry, Match, Submatch } from "@apt5/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("/v2/FileSystem") {}

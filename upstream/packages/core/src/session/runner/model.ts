...
import { type Model } from "@apt5/llm"
import * as AnthropicMessages from "@apt5/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@apt5/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@apt5/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@apt5/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("/v2/SessionRunnerModel") {}

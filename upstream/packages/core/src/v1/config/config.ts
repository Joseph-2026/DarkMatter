...
export const Info = Schema.Struct({
  ...
  command: Schema.optional(Schema.Record(Schema.String, ConfigCommandV1.Info)).annotate({
    description: "Command configuration, see https://github.com/Joseph-2026/DarkMatter/docs/commands",
  }),
  ...
  ).annotate({ description: "Agent configuration, see https://github.com/Joseph-2026/DarkMatter/docs/agents" }),

...
import { Event } from "@apt5/schema/project-directories"
import { ProjectCopy } from "@apt5/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("/ProjectCopy") {}

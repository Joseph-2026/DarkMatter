...
import { ListAnchor } from "@apt5/schema/session"
...
import { SessionDurable } from "@apt5/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("/v2/Session") {}

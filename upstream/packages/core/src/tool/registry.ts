...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@apt5/llm"
...
export class Service extends Context.Service<Service, Interface>()("/v2/ToolRegistry") {}

...
import { ToolFailure } from "@apt5/llm"
...
export class ConfigService extends Context.Service<ConfigService, Config>()("/v2/WebSearchConfig") {}

/** Isolates the retained product environment contract from the generic tool implementation. */
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.APT5_WEBSEARCH_PROVIDER === "exa" || process.env.APT5_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.APT5_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("APT5_EXPERIMENTAL") || truthy("APT5_ENABLE_EXA") || truthy("APT5_EXPERIMENTAL_EXA"),
    enableParallel: truthy("APT5_ENABLE_PARALLEL") || truthy("APT5_EXPERIMENTAL_PARALLEL"),

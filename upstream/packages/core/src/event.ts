...
import type { Data, Definition, Payload } from "@apt5/schema/event"
...
import { Durable } from "@apt5/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@apt5/schema/event").ID
export type { Data, Definition, Payload } from "@apt5/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("/Event") {}

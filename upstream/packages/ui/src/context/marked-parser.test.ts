...
test("renders links with application attributes", async () => {
  expect(await parser.parse("[OpenCode](https://github.com/Joseph-2026/DarkMatter)")).toBe(
    '<p><a href="https://github.com/Joseph-2026/DarkMatter" class="external-link" target="_blank" rel="noopener noreferrer">OpenCode</a></p>\n',
  )
})

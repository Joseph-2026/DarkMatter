...
beforeAll(async () => {
  ...
  mock.module("@apt5/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@apt5/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@apt5/ui/icon", () => ({ Icon: () => null }))
  mock.module("@apt5/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))

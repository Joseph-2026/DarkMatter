...
import { Switch } from "@apt5/ui/v2/switch-v2"
        ...
        <SettingsRowV2
          ...
          description={
            <>
              ...
              <ExternalLink class="settings-v2-link" href="https://github.com/Joseph-2026/DarkMatter/docs/themes/">
  ...
  const GeneralSection = () => (
    <div class="settings-v2-section">
      <SettingsListV2>
        ...
        <Show when={mobile() && import.meta.env.VITE_APT5_CHANNEL !== "prod"}>
          <SettingsRowV2

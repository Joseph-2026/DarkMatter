...
export const dict = {
  ...
  "desktop.wsl.error.apt5Missing": "此發行版中未安裝 opencode",
  "desktop.wsl.error.apt5CannotRun": "已安裝 opencode，但無法執行",
  "desktop.wsl.error.apt5NotInstalled": "{{distro}} 中未安裝 OpenCode",
  ...
  "provider.connect.apt5Zen.line1": "OpenCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "wsl.onboarding.checkingApt5In": "正在檢查 {{distro}} 中的 OpenCode...",
  "wsl.onboarding.updatingOpencode": "正在更新 OpenCode...",
  "wsl.onboarding.updatingApt5In": "正在更新 {{distro}} 中的 OpenCode...",
  "wsl.onboarding.updateApt5In": "更新 {{distro}} 中的 OpenCode。",
  "wsl.onboarding.updateOpencode": "更新 OpenCode",
  "wsl.onboarding.apt5ReadyIn": "{{distro}} 中的 OpenCode 已就緒。",
  "wsl.onboarding.apt5Ready": "OpenCode 已就緒。",
  "wsl.onboarding.installApt5In": "在 {{distro}} 中安裝 OpenCode。",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "未安裝 OpenCode",

...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "APT-5 載入失敗",
  "desktop.recovery.terminated": "APT-5 視窗意外終止",
  "desktop.recovery.unresponsive": "APT-5 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "APT-5 安裝失敗",
  "desktop.wsl.error.alreadyAdded": "已新增 {{distro}}",
  "desktop.wsl.error.apt5Missing": "此發行版中未安裝 apt-5",
  "desktop.wsl.error.apt5CannotRun": "已安裝 apt-5，但無法執行",
  "desktop.wsl.error.apt5NotInstalled": "{{distro}} 中未安裝 APT-5",
  "desktop.wsl.error.updateVersion":
    "APT-5 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.provider.apt5.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.apt5.tagline": "經過最佳化的可靠模型",
  "dialog.provider.apt5Go.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "APT-5 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 APT-5 中使用 {{provider}} 模型。",
  ...
  "provider.connect.apt5Zen.line1": "APT-5 Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.apt5Zen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.apt5Zen.visit.prefix": "造訪 ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 APT-5 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 APT-5 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 apt5.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 APT-5 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 APT-5...",
  "wsl.onboarding.checkingApt5In": "正在檢查 {{distro}} 中的 APT-5...",
  ...
  "wsl.onboarding.apt5ReadyIn": "{{distro}} 中的 APT-5 已就緒。",
  "wsl.onboarding.apt5Ready": "APT-5 已就緒。",
  "wsl.onboarding.installApt5In": "在 {{distro}} 中安裝 APT-5。",
  "wsl.onboarding.installOpencode": "安裝 APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "未安裝 APT-5",
  ...
  "wsl.onboarding.wslUnavailable.description": "APT-5 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 APT-5。",
  ...
  "help.tabs.introduction": "APT-5 Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "APT-5 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 APT-5 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (apt5.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：APT-5 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "APT-5 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 APT-5 伺服器。",
  ...
  "settings.general.row.language.description": "變更 APT-5 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 APT-5 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 APT-5 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 APT-5 的主題。",
  ...
  "settings.updates.row.startup.description": "在 APT-5 啟動時自動檢查更新",

export const dict = {
  ...
  "wsl.onboarding.checkingApt5In": "{{distro}}에서 OpenCode 확인 중...",
  "wsl.onboarding.updatingOpencode": "OpenCode 업데이트 중...",
  "wsl.onboarding.updatingApt5In": "{{distro}}에서 OpenCode 업데이트 중...",
  "wsl.onboarding.updateApt5In": "{{distro}}에서 OpenCode를 업데이트하세요.",
  "wsl.onboarding.updateOpencode": "OpenCode 업데이트",
  "wsl.onboarding.apt5ReadyIn": "{{distro}}에서 OpenCode를 사용할 준비가 되었습니다.",
  "wsl.onboarding.apt5Ready": "OpenCode가 준비되었습니다.",
  "wsl.onboarding.installApt5In": "{{distro}}에 OpenCode를 설치하세요.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCode가 설치되지 않음",
  ...
  "desktop.wsl.error.apt5Missing": "이 배포판에 opencode가 설치되어 있지 않습니다",
  "desktop.wsl.error.apt5CannotRun": "opencode가 설치되어 있지만 실행할 수 없습니다",
  "desktop.wsl.error.apt5NotInstalled": "{{distro}}에 OpenCode가 설치되어 있지 않습니다",

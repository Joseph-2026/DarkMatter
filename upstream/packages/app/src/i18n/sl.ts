export const dict = {
  ...
  "desktop.menu.documentation": "APT-5 Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "APT-5 ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno APT-5 se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "APT-5 se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev APT-5 ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.apt5Missing": "apt-5 ni nameščen v tej distribuciji",
  "desktop.wsl.error.apt5CannotRun": "apt-5 je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev APT-5 je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.apt5.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.apt5.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.apt5Go.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja APT-5",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.apt5Zen.visit.prefix": "Obisk ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v APT-5.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v apt5.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom APT-5 se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje APT-5 ...",
  "wsl.onboarding.checkingApt5In": "Preverjanje APT-5 v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje APT-5 ...",
  "wsl.onboarding.updatingApt5In": "Posodabljanje APT-5 v {{distro}} ...",
  "wsl.onboarding.updateApt5In": "Posodobite APT-5 v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 je pripravljen v {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 je pripravljen.",
  "wsl.onboarding.installApt5In": "Namestite APT-5 v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko APT-5 doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "APT-5 ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite APT-5.",
  ...
  "help.tabs.introduction": "APT-5 Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica APT-5 ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi APT-5",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (apt5.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, APT-5 še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik APT-5 znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za APT-5",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako APT-5 izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali APT-5 sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo APT-5.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene APT-5",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico APT-5.",

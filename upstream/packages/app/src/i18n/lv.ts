export const dict = {
  ...
  "desktop.menu.documentation": "APT-5 dokumentācija",
  ...
  "desktop.menu.ariaLabel": "APT-5 izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt APT-5",
  "desktop.recovery.terminated": "APT-5 logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "APT-5 neatbild",
  ...
  "desktop.wsl.error.installOpencode": "APT-5 instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.apt5Missing": "apt-5 nav instalēts šajā distribūcijā",
  "desktop.wsl.error.apt5CannotRun": "apt-5 ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "APT-5 atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.apt5.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.apt5.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.apt5Go.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no APT-5",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus APT-5.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti apt5.json",
  ...
  "dialog.server.description": "Mainiet, pie kura APT-5 servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingOpencode": "Pārbaudu APT-5...",
  "wsl.onboarding.checkingApt5In": "Pārbaudu APT-5 distribūcijā {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atjauninu APT-5...",
  "wsl.onboarding.updatingApt5In": "Atjauninu APT-5 distribūcijā {{distro}}...",
  "wsl.onboarding.updateApt5In": "Atjauniniet APT-5 distribūcijā {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atjauniniet APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 ir gatavs.",
  "wsl.onboarding.installApt5In": "Instalējiet APT-5 distribūcijā {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalējiet APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms APT-5 var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "APT-5 neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet APT-5 no jauna.",
  ...
  "help.tabs.introduction": "APT-5 Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna APT-5 versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu APT-5 komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (apt5.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, APT-5 vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "APT-5 darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist APT-5 serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt APT-5 saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā APT-5 izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai APT-5 sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet APT-5 tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot APT-5",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko APT-5 versiju.",

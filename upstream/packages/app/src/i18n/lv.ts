export const dict = {
  ...
  "desktop.wsl.error.apt5Missing": "opencode nav instalēts šajā distribūcijā",
  "desktop.wsl.error.apt5CannotRun": "opencode ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.apt5NotInstalled": "OpenCode nav instalēts {{distro}}",
  ...
  "wsl.onboarding.checkingApt5In": "Pārbaudu OpenCode distribūcijā {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atjauninu OpenCode...",
  "wsl.onboarding.updatingApt5In": "Atjauninu OpenCode distribūcijā {{distro}}...",
  "wsl.onboarding.updateApt5In": "Atjauniniet OpenCode distribūcijā {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atjauniniet OpenCode",
  "wsl.onboarding.apt5ReadyIn": "OpenCode ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.apt5Ready": "OpenCode ir gatavs.",
  "wsl.onboarding.installApt5In": "Instalējiet OpenCode distribūcijā {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCode nav instalēts",

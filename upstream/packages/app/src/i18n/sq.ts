export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni APT-5",
  ...
  "desktop.menu.ariaLabel": "Menuja APT-5",
  ...
  "desktop.recovery.loadFailed": "APT-5 nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja APT-5 u mbyll papritur",
  "desktop.recovery.unresponsive": "APT-5 nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i APT-5 dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.apt5Missing": "Opencode nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.apt5CannotRun": "Opencode është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i APT-5 përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.apt5.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.apt5.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.apt5Go.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga APT-5",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.apt5Zen.visit.prefix": "Vizitoni ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në APT-5.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në apt5.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server APT-5 lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon APT-5...",
  "wsl.onboarding.checkingApt5In": "Po kontrollon APT-5 në {{distro}}...",
  "wsl.onboarding.updatingOpencode": "APT-5 po përditësohet...",
  "wsl.onboarding.updatingApt5In": "Po përditëson APT-5 në {{distro}}...",
  "wsl.onboarding.updateApt5In": "Përditëso APT-5 në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 është gati në {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 është gati.",
  "wsl.onboarding.installApt5In": "Instaloni APT-5 në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se APT-5 të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "APT-5 nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap APT-5.",
  ...
  "help.tabs.introduction": "APT-5 Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i APT-5 ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i APT-5",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (apt5.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, APT-5 nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin APT-5 brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për APT-5",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket APT-5 në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse APT-5 ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e APT-5.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset APT-5",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të APT-5.",

export const dict = {
  ...
  "desktop.wsl.error.apt5Missing": "このディストリビューションにはopencodeがインストールされていません",
  "desktop.wsl.error.apt5CannotRun": "opencodeはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.apt5NotInstalled": "{{distro}}にはOpenCodeがインストールされていません",
  ...
  "wsl.onboarding.checkingApt5In": "{{distro}}内のOpenCodeを確認中...",
  "wsl.onboarding.updatingOpencode": "OpenCodeを更新中...",
  "wsl.onboarding.updatingApt5In": "{{distro}}内のOpenCodeを更新中...",
  "wsl.onboarding.updateApt5In": "{{distro}}内のOpenCodeを更新してください。",
  "wsl.onboarding.updateOpencode": "OpenCodeを更新",
  "wsl.onboarding.apt5ReadyIn": "{{distro}}内のOpenCodeの準備ができました。",
  "wsl.onboarding.apt5Ready": "OpenCodeの準備ができました。",
  "wsl.onboarding.installApt5In": "{{distro}}にOpenCodeをインストールしてください。",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCodeがインストールされていません",

export const dict = {
  ...
  "desktop.recovery.loadFailed": "APT-5を読み込めませんでした",
  "desktop.recovery.terminated": "APT-5のウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "APT-5が応答していません",
  ...
  "desktop.wsl.error.installOpencode": "APT-5のインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.apt5Missing": "このディストリビューションにはapt-5がインストールされていません",
  "desktop.wsl.error.apt5CannotRun": "apt-5はインストールされていますが、実行できませんでした",
  "desktop.wsl.error.apt5NotInstalled": "{{distro}}にはAPT-5がインストールされていません",
  "desktop.wsl.error.updateVersion":
    "APT-5のアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.apt5.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.apt5.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.apt5Go.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "APT-5が提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、APT-5で{{provider}}モデルを使用します。",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.apt5Zen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.apt5Zen.visit.prefix": " ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してAPT-5で{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、APT-5で{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "apt5.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するAPT-5サーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "APT-5を確認中...",
  "wsl.onboarding.checkingApt5In": "{{distro}}内のAPT-5を確認中...",
  "wsl.onboarding.updatingOpencode": "APT-5を更新中...",
  "wsl.onboarding.updatingApt5In": "{{distro}}内のAPT-5を更新中...",
  "wsl.onboarding.updateApt5In": "{{distro}}内のAPT-5を更新してください。",
  "wsl.onboarding.updateOpencode": "APT-5を更新",
  "wsl.onboarding.apt5ReadyIn": "{{distro}}内のAPT-5の準備ができました。",
  "wsl.onboarding.apt5Ready": "APT-5の準備ができました。",
  "wsl.onboarding.installApt5In": "{{distro}}にAPT-5をインストールしてください。",
  "wsl.onboarding.installOpencode": "APT-5をインストール",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5がインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "APT-5でWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、APT-5をもう一度開いてください。",
  ...
  "help.tabs.introduction": "APT-5 Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "APT-5の新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをAPT-5チームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (apt5.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: APT-5はまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "APT-5には無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でAPT-5サーバーを実行します。",
  ...
  "settings.general.row.language.description": "APT-5の表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのAPT-5の表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "APT-5がシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "APT-5のテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "APT-5 の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "APT-5 は最新バージョンです。",

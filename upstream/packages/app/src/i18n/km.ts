export const dict = {
  ...
  "desktop.menu.documentation": "ឯកសារ APT-5",
  ...
  "desktop.menu.ariaLabel": "ម៉ឺនុយ APT-5",
  ...
  "desktop.recovery.loadFailed": "APT-5 បានបរាជ័យក្នុងការផ្ទុក",
  "desktop.recovery.terminated": "បង្អួច APT-5 ត្រូវបានបញ្ចប់ដោយមិននឹកស្មានដល់",
  "desktop.recovery.unresponsive": "APT-5 មិនឆ្លើយតបទេ។",
  ...
  "desktop.wsl.error.installOpencode": "ការដំឡើង APT-5 បានបរាជ័យ",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ត្រូវបានបន្ថែមរួចហើយ",
  "desktop.wsl.error.apt5Missing": "apt-5 មិនត្រូវបានដំឡើងនៅក្នុង distro នេះទេ។",
  "desktop.wsl.error.apt5CannotRun": "apt-5 ត្រូវបានដំឡើង ប៉ុន្តែមិនអាចដំណើរការបានទេ។",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 មិនត្រូវបានដំឡើងនៅក្នុង {{distro}} ទេ។",
  "desktop.wsl.error.updateVersion":
    "ការធ្វើបច្ចុប្បន្នភាព APT-5 បានបញ្ចប់ ប៉ុន្តែ {{distro}} នៅតែរាយការណ៍ {{installed}}; {{expected}} រំពឹងទុក",
  ...
  "dialog.provider.apt5.note": "ម៉ូដែលដែលបានជ្រើសរើសរួមមាន Claude, GPT, Gemini និងច្រើនទៀត",
  "dialog.provider.apt5.tagline": "ម៉ូដែលដែលបានកែលម្អដែលអាចទុកចិត្តបាន។",
  "dialog.provider.apt5Go.tagline": "ការជាវតម្លៃទាបសម្រាប់អ្នករាល់គ្នា",
  ...
  "dialog.model.unpaid.freeModels.title": "ម៉ូដែលឥតគិតថ្លៃដែលផ្តល់ដោយ APT-5",
  ...
  "provider.connect.apiKey.description":
    "បញ្ចូល {{provider}} API key របស់អ្នក ដើម្បីភ្ជាប់គណនីរបស់អ្នក ហើយប្រើម៉ូដែល {{provider}} នៅក្នុង APT-5។",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ហើយបញ្ចូលលេខកូដខាងក្រោមដើម្បីភ្ជាប់គណនីរបស់អ្នក ហើយប្រើម៉ូដែល {{provider}} នៅក្នុង APT-5។",
  ...
  "dialog.plugins.empty": "កម្មវិធីជំនួយដែលបានកំណត់រចនាសម្ព័ន្ធនៅក្នុង apt5.json",
  ...
  "dialog.server.description": "ប្តូរម៉ាស៊ីនមេ APT-5 ដែលកម្មវិធីនេះភ្ជាប់ទៅ។",
  ...
  "wsl.onboarding.checkingOpencode": "កំពុងពិនិត្យមើលកូដ APT-5...",
  "wsl.onboarding.checkingApt5In": "កំពុងពិនិត្យកូដ APT-5 ក្នុង {{distro}}...",
  "wsl.onboarding.updatingOpencode": "កំពុងអាប់ដេត APT-5...",
  "wsl.onboarding.updatingApt5In": "កំពុងអាប់ដេត APT-5 ក្នុង {{distro}}...",
  "wsl.onboarding.updateApt5In": "ធ្វើបច្ចុប្បន្នភាព APT-5 ក្នុង {{distro}} ។",
  "wsl.onboarding.updateOpencode": "ធ្វើបច្ចុប្បន្នភាព APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 គឺរួចរាល់នៅក្នុង {{distro}} ។",
  "wsl.onboarding.apt5Ready": "APT-5 គឺរួចរាល់។",
  "wsl.onboarding.installApt5In": "ដំឡើង APT-5 ក្នុង {{distro}} ។",
  "wsl.onboarding.installOpencode": "ដំឡើង APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 មិនត្រូវបានដំឡើងទេ។",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (ប្រព័ន្ធរងវីនដូសម្រាប់លីនុច) ត្រូវបានទាមទារ មុនពេល APT-5 អាចបន្ថែមម៉ាស៊ីនមេ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL មិនអាចប្រើបានទេ។",
  "wsl.onboarding.wslUnavailable.description": "APT-5 មិនអាចផ្ទៀងផ្ទាត់ WSL នៅលើម៉ាស៊ីននេះបានទេ។",
  "wsl.onboarding.installWsl": "ដំឡើង WSL",
  "wsl.onboarding.windowsRestartRequired":
    "ចាប់ផ្ដើម Windows ឡើងវិញ ដើម្បីបញ្ចប់ការដំឡើង WSL បន្ទាប់មកបើក APT-5 ឡើងវិញ។",
  ...
  "help.tabs.introduction": "APT-5 Desktop ឥឡូវនេះត្រូវបានបង្កើតឡើងនៅជុំវិញផ្ទាំង។",
  "help.tabs.sessions":
  ...
  "toast.update.description": "កំណែថ្មីនៃ APT-5 ({{version}}) ឥឡូវនេះមានសម្រាប់ដំឡើងហើយ។",
  ...
  "error.page.report.prefix": "សូមរាយការណ៍ពីកំហុសនេះទៅកាន់ក្រុម APT-5",
  ...
  "error.chain.checkConfig": "ពិនិត្យការកំណត់រចនាសម្ព័ន្ធរបស់អ្នក (apt5.json) អ្នកផ្តល់សេវា/ឈ្មោះម៉ូដែល",
  "error.chain.mcpFailed": 'ម៉ាស៊ីនមេ MCP "{{name}}" បានបរាជ័យ។ ចំណាំ APT-5 មិនគាំទ្រការផ្ទៀងផ្ទាត់ MCP នៅឡើយទេ។',
  ...
  "sidebar.gettingStarted.line1": "APT-5 រួមបញ្ចូលម៉ូដែលឥតគិតថ្លៃ ដូច្នេះអ្នកអាចចាប់ផ្តើមភ្លាមៗ។",
  ...
  "settings.desktop.wsl.description": "ដំណើរការម៉ាស៊ីនមេ APT-5 នៅខាងក្នុង WSL នៅលើ Windows ។",
  ...
  "settings.general.row.language.description": "ប្តូរភាសាបង្ហាញសម្រាប់ APT-5",
  ...
  "settings.general.row.appearance.description": "ប្ដូរតាមបំណងពីរបៀបដែល APT-5 មើលទៅលើឧបករណ៍របស់អ្នក។",
  "settings.general.row.colorScheme.title": "ពណ៌ចម្រុះ",
  "settings.general.row.colorScheme.description": "ជ្រើសរើសថាតើ APT-5 ធ្វើតាមប្រព័ន្ធ ពន្លឺ ឬរូបរាងងងឹត",
  "settings.general.row.theme.title": "ស្បែក",
  "settings.general.row.theme.description": "ប្ដូរតាមបំណងពីរបៀបដែល APT-5 មានប្រធានបទ។",
  ...
  "settings.updates.row.startup.description": "ពិនិត្យមើលការអាប់ដេតដោយស្វ័យប្រវត្តិនៅពេលដែល APT-5 ចាប់ផ្តើម",
  ...
  "settings.updates.toast.latest.description": "អ្នកកំពុងដំណើរការកំណែចុងក្រោយបំផុតនៃ APT-5 ។",

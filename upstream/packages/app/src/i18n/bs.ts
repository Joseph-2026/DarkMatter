export const dict = {
  ...
  "desktop.wsl.error.apt5Missing": "opencode nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.apt5CannotRun": "opencode je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.apt5NotInstalled": "OpenCode nije instaliran u distribuciji {{distro}}",
  ...
  "wsl.onboarding.checkingApt5In": "Provjera OpenCode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje OpenCode...",
  "wsl.onboarding.updatingApt5In": "Ažuriranje OpenCode u distribuciji {{distro}}...",
  "wsl.onboarding.updateApt5In": "Ažuriraj OpenCode u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj OpenCode",
  "wsl.onboarding.apt5ReadyIn": "OpenCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.apt5Ready": "OpenCode je spreman.",
  "wsl.onboarding.installApt5In": "Instaliraj OpenCode u distribuciji {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCode nije instaliran",

export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za APT-5",
  ...
  "desktop.menu.ariaLabel": "APT-5 meni",
  ...
  "desktop.recovery.loadFailed": "APT-5 se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor APT-5-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "APT-5 ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija APT-5-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.apt5Missing": "apt-5 nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.apt5CannotRun": "apt-5 je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje APT-5-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.apt5.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.apt5.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.apt5Go.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje APT-5",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u APT-5-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u APT-5-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u apt5.json",
  ...
  "dialog.server.description": "Promijeni na koji se APT-5 server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera APT-5...",
  "wsl.onboarding.checkingApt5In": "Provjera APT-5 u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje APT-5...",
  "wsl.onboarding.updatingApt5In": "Ažuriranje APT-5 u distribuciji {{distro}}...",
  "wsl.onboarding.updateApt5In": "Ažuriraj APT-5 u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 je spreman.",
  "wsl.onboarding.installApt5In": "Instaliraj APT-5 u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi APT-5 mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "APT-5 nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori APT-5.",
  ...
  "help.tabs.introduction": "APT-5 Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija APT-5-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku APT-5 timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (apt5.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: APT-5 još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni APT-5 server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u APT-5-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako APT-5 izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li APT-5 prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu APT-5-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se APT-5 pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju APT-5-a.",

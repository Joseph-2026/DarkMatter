...
export const dict = {
  ...
  "dialog.provider.apt5.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.apt5.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.apt5Go.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von APT-5",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in APT-5 zu nutzen.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.apt5Zen.visit.prefix": "Besuchen Sie ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in APT-5 zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in APT-5 zu nutzen.",
  ...
  "dialog.plugins.empty": "In apt5.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den APT-5-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "APT-5 wird geprüft…",
  "wsl.onboarding.checkingApt5In": "APT-5 in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "APT-5 wird aktualisiert…",
  "wsl.onboarding.updatingApt5In": "APT-5 in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateApt5In": "Aktualisieren Sie APT-5 in {{distro}}.",
  "wsl.onboarding.updateOpencode": "APT-5 aktualisieren",
  "wsl.onboarding.apt5ReadyIn": "APT-5 ist in {{distro}} bereit.",
  "wsl.onboarding.apt5Ready": "APT-5 ist bereit.",
  "wsl.onboarding.installApt5In": "Installieren Sie APT-5 in {{distro}}.",
  "wsl.onboarding.installOpencode": "APT-5 installieren",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor APT-5 einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "APT-5 konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann APT-5 erneut.",
  ...
  "toast.update.description": "Eine neue Version von APT-5 ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem APT-5-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (apt5.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: APT-5 unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "APT-5 mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "APT-5 enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "APT-5 Desktop",
  ...
  "settings.desktop.wsl.description": "APT-5-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für APT-5 ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie APT-5 auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob APT-5 dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von APT-5 anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von APT-5 automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "APT-5 ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von APT-5 wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "APT-5 konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das APT-5-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "APT-5 reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "APT-5-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.apt5Missing": "apt-5 ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.apt5CannotRun": "apt-5 ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das APT-5-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "APT-5 Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":

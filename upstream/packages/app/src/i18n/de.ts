...
export const dict = {
  ...
  "wsl.onboarding.checkingApt5In": "OpenCode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "OpenCode wird aktualisiert…",
  "wsl.onboarding.updatingApt5In": "OpenCode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateApt5In": "Aktualisieren Sie OpenCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "OpenCode aktualisieren",
  "wsl.onboarding.apt5ReadyIn": "OpenCode ist in {{distro}} bereit.",
  "wsl.onboarding.apt5Ready": "OpenCode ist bereit.",
  "wsl.onboarding.installApt5In": "Installieren Sie OpenCode in {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCode nicht installiert",
  ...
  "desktop.wsl.error.apt5Missing": "opencode ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.apt5CannotRun": "opencode ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.apt5NotInstalled": "OpenCode ist in {{distro}} nicht installiert",

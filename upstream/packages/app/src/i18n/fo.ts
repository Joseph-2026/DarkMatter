export const dict = {
  ...
  "desktop.menu.documentation": "APT-5 Skjøl",
  ...
  "desktop.menu.ariaLabel": "APT-5 valmynd",
  ...
  "desktop.recovery.loadFailed": "APT-5 miseydnaðist at heinta",
  "desktop.recovery.terminated": "APT-5 vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "APT-5 svarar ikki",
  ...
  "desktop.wsl.error.installOpencode": "APT-5 uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.apt5Missing": "apt-5 er ikki sett upp í hesi distro",
  "desktop.wsl.error.apt5CannotRun": "apt-5 er sett upp men kundi ikki koyra",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "APT-5 dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.apt5.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.apt5.tagline": "Álítandi optimerað modell",
  "dialog.provider.apt5Go.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av APT-5",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.apt5Zen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.apt5Zen.visit.prefix": "Vitja ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í APT-5.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í apt5.json",
  ...
  "dialog.server.description": "Skift hvønn APT-5 ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna APT-5...",
  "wsl.onboarding.checkingApt5In": "Kanna APT-5 í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dagføring APT-5...",
  "wsl.onboarding.updatingApt5In": "Dagføring APT-5 í {{distro}}...",
  "wsl.onboarding.updateApt5In": "Dagfør APT-5 í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 er klárt í {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 er klárt.",
  "wsl.onboarding.installApt5In": "Set APT-5 upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn APT-5 kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "APT-5 kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani APT-5 aftur.",
  ...
  "help.tabs.introduction": "APT-5 Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av APT-5 ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til APT-5 toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (apt5.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, APT-5 stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "APT-5 Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr APT-5 ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri APT-5",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu APT-5 sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um APT-5 fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu APT-5 er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá APT-5 byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av APT-5.",

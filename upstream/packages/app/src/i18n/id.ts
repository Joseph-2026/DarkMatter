export const dict = {
  ...
  "desktop.recovery.loadFailed": "APT-5 gagal dimuat",
  "desktop.recovery.terminated": "Jendela APT-5 berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "APT-5 tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi APT-5 gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.apt5Missing": "apt-5 belum terinstal di distro ini",
  "desktop.wsl.error.apt5CannotRun": "apt-5 telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan APT-5 selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.apt5.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.apt5.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.apt5Go.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh APT-5",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.apt5Zen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di APT-5.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di apt5.json",
  ...
  "dialog.server.description": "Ganti server APT-5 mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa APT-5...",
  "wsl.onboarding.checkingApt5In": "Memeriksa APT-5 di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui APT-5...",
  "wsl.onboarding.updatingApt5In": "Memperbarui APT-5 di {{distro}}...",
  "wsl.onboarding.updateApt5In": "Perbarui APT-5 di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 siap di {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 siap.",
  "wsl.onboarding.installApt5In": "Instal APT-5 di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum APT-5 dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "APT-5 tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali APT-5.",
  ...
  "help.tabs.introduction": "APT-5 Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru APT-5 ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim APT-5",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (apt5.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: APT-5 belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server APT-5 di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk APT-5",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan APT-5 di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah APT-5 mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat APT-5 diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru APT-5.",

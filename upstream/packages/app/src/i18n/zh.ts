...
export const dict = {
  ...
  "desktop.wsl.error.apt5Missing": "此发行版中未安装 opencode",
  "desktop.wsl.error.apt5CannotRun": "已安装 opencode，但无法运行",
  "desktop.wsl.error.apt5NotInstalled": "{{distro}} 中未安装 OpenCode",
  ...
  "provider.connect.apt5Zen.line1": "OpenCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "wsl.onboarding.checkingApt5In": "正在检查 {{distro}} 中的 OpenCode...",
  ...
  "wsl.onboarding.apt5ReadyIn": "{{distro}} 中的 OpenCode 已就绪。",
  "wsl.onboarding.apt5Ready": "OpenCode 已就绪。",
  "wsl.onboarding.installApt5In": "在 {{distro}} 中安装 OpenCode。",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "未安装 OpenCode",

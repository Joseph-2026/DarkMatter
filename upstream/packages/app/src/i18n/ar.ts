export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل APT-5",
  "desktop.recovery.terminated": "توقفت نافذة APT-5 بشكل غير متوقع",
  "desktop.recovery.unresponsive": "APT-5 لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت APT-5",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.apt5Missing": "apt-5 غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.apt5CannotRun": "apt-5 مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث APT-5، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.apt5.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.apt5.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.apt5Go.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من APT-5",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "يمنحك APT-5 Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.apt5Zen.visit.prefix": "قم بزيارة ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في APT-5.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في apt5.json",
  ...
  "dialog.server.description": "تبديل خادم APT-5 الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من APT-5...",
  "wsl.onboarding.checkingApt5In": "جارٍ التحقق من APT-5 في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث APT-5...",
  "wsl.onboarding.updatingApt5In": "جارٍ تحديث APT-5 في {{distro}}...",
  "wsl.onboarding.updateApt5In": "حدّث APT-5 في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 جاهز في {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 جاهز.",
  "wsl.onboarding.installApt5In": "ثبّت APT-5 في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن APT-5 من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على APT-5 التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح APT-5.",
  ...
  "help.tabs.introduction": "أصبح APT-5 Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من APT-5 ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق APT-5",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (apt5.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن APT-5 لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن APT-5 نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم APT-5 داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ APT-5",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور APT-5 على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان APT-5 يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة APT-5.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل APT-5",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من APT-5.",

export const dict = {
  ...
  "desktop.wsl.error.apt5Missing": "opencode غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.apt5CannotRun": "opencode مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.apt5NotInstalled": "OpenCode غير مثبت في {{distro}}",
  ...
  "wsl.onboarding.checkingApt5In": "جارٍ التحقق من OpenCode في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث OpenCode...",
  "wsl.onboarding.updatingApt5In": "جارٍ تحديث OpenCode في {{distro}}...",
  "wsl.onboarding.updateApt5In": "حدّث OpenCode في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث OpenCode",
  "wsl.onboarding.apt5ReadyIn": "OpenCode جاهز في {{distro}}.",
  "wsl.onboarding.apt5Ready": "OpenCode جاهز.",
  "wsl.onboarding.installApt5In": "ثبّت OpenCode في {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCode غير مثبت",

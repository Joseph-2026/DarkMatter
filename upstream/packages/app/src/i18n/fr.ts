export const dict = {
  ...
  "desktop.wsl.error.apt5Missing": "opencode n'est pas installé dans cette distribution",
  "desktop.wsl.error.apt5CannotRun": "opencode est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.apt5NotInstalled": "OpenCode n'est pas installé dans {{distro}}",
  ...
  "wsl.onboarding.checkingApt5In": "Vérification d'OpenCode dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'OpenCode...",
  "wsl.onboarding.updatingApt5In": "Mise à jour d'OpenCode dans {{distro}}...",
  "wsl.onboarding.updateApt5In": "Mettez à jour OpenCode dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour OpenCode",
  "wsl.onboarding.apt5ReadyIn": "OpenCode est prêt dans {{distro}}.",
  "wsl.onboarding.apt5Ready": "OpenCode est prêt.",
  "wsl.onboarding.installApt5In": "Installez OpenCode dans {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCode non installé",

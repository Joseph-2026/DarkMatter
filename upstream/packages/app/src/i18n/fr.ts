export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'APT-5",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'APT-5",
  "desktop.recovery.terminated": "La fenêtre APT-5 s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "APT-5 ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'APT-5",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.apt5Missing": "apt-5 n'est pas installé dans cette distribution",
  "desktop.wsl.error.apt5CannotRun": "apt-5 est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'APT-5 est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.apt5.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.apt5.tagline": "Modèles optimisés et fiables",
  "dialog.provider.apt5Go.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par APT-5",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.apt5Zen.visit.prefix": "Visitez ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans APT-5.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans apt5.json",
  ...
  "dialog.server.description": "Changez le serveur APT-5 auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'APT-5...",
  "wsl.onboarding.checkingApt5In": "Vérification d'APT-5 dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'APT-5...",
  "wsl.onboarding.updatingApt5In": "Mise à jour d'APT-5 dans {{distro}}...",
  "wsl.onboarding.updateApt5In": "Mettez à jour APT-5 dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 est prêt dans {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 est prêt.",
  "wsl.onboarding.installApt5In": "Installez APT-5 dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'APT-5 puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "APT-5 n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez APT-5.",
  ...
  "help.tabs.introduction": "APT-5 Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'APT-5 ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe APT-5",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (apt5.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'APT-5 ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "APT-5 inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur APT-5 dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour APT-5",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'APT-5 sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si APT-5 suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'APT-5.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'APT-5",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'APT-5.",

export const dict = {
  ...
  "desktop.recovery.loadFailed": "APT-5 yüklənə bilmədi",
  "desktop.recovery.terminated": "APT-5 pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "APT-5 cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "APT-5 quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.apt5Missing": "Bu distribütivdə apt-5 quraşdırılmayıb",
  "desktop.wsl.error.apt5CannotRun": "apt-5 quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "APT-5 yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.apt5.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.apt5.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.apt5Go.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "APT-5 tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və APT-5-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.apt5Zen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və APT-5-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və APT-5-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu APT-5 serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "APT-5 yoxlanılır...",
  "wsl.onboarding.checkingApt5In": "{{distro}}-də APT-5 yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "APT-5 yenilənir...",
  "wsl.onboarding.updatingApt5In": "{{distro}}-də APT-5 yenilənir...",
  "wsl.onboarding.updateApt5In": "{{distro}}-də APT-5-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "APT-5-u yeniləyin",
  "wsl.onboarding.apt5ReadyIn": "APT-5 {{distro}}-də hazırdır.",
  "wsl.onboarding.apt5Ready": "APT-5 hazırdır.",
  "wsl.onboarding.installApt5In": "APT-5-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "APT-5 quraşdırın",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "APT-5 WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "APT-5 bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra APT-5-u yenidən açın.",
  ...
  "help.tabs.introduction": "APT-5 Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "APT-5-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı APT-5 komandasına",
  ...
  "sidebar.gettingStarted.line1": "APT-5-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində APT-5 serverini işlət.",
  ...
  "settings.general.row.language.description": "APT-5 üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "APT-5-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "APT-5-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "APT-5-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "APT-5 açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "APT-5-un ən son versiyasından istifadə edirsiniz.",

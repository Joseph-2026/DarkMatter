export const dict = {
  ...
  "desktop.wsl.error.apt5Missing": "Bu distribütivdə opencode quraşdırılmayıb",
  "desktop.wsl.error.apt5CannotRun": "opencode quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.apt5NotInstalled": "OpenCode {{distro}} distribütivində quraşdırılmayıb",
  ...
  "wsl.onboarding.checkingApt5In": "{{distro}}-də OpenCode yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "OpenCode yenilənir...",
  "wsl.onboarding.updatingApt5In": "{{distro}}-də OpenCode yenilənir...",
  "wsl.onboarding.updateApt5In": "{{distro}}-də OpenCode-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "OpenCode-u yeniləyin",
  "wsl.onboarding.apt5ReadyIn": "OpenCode {{distro}}-də hazırdır.",
  "wsl.onboarding.apt5Ready": "OpenCode hazırdır.",
  "wsl.onboarding.installApt5In": "OpenCode-u {{distro}}-də quraşdırın.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCode quraşdırılmayıb",

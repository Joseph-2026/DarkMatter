export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja APT-5",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać APT-5",
  "desktop.recovery.terminated": "Okno APT-5 zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "APT-5 nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować APT-5",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.apt5Missing": "Program apt-5 nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.apt5CannotRun": "Program apt-5 jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja APT-5 została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.apt5.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.apt5.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.apt5Go.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez APT-5",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.apt5Zen.visit.prefix": "Odwiedź ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w APT-5.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku apt5.json",
  ...
  "dialog.server.description": "Przełącz serwer APT-5, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie APT-5...",
  "wsl.onboarding.checkingApt5In": "Sprawdzanie APT-5 w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie APT-5...",
  "wsl.onboarding.updatingApt5In": "Aktualizowanie APT-5 w dystrybucji {{distro}}...",
  "wsl.onboarding.updateApt5In": "Zaktualizuj APT-5 w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 jest gotowy.",
  "wsl.onboarding.installApt5In": "Zainstaluj APT-5 w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim APT-5 będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "APT-5 nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz APT-5.",
  ...
  "help.tabs.introduction": "APT-5 Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja APT-5 ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu APT-5",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (apt5.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: APT-5 nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "APT-5 zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer APT-5 wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla APT-5",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd APT-5 na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy APT-5 ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw APT-5.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania APT-5",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji APT-5.",

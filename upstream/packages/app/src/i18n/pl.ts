export const dict = {
  ...
  "desktop.wsl.error.apt5Missing": "Program opencode nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.apt5CannotRun": "Program opencode jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.apt5NotInstalled": "OpenCode nie jest zainstalowany w dystrybucji {{distro}}",
  ...
  "wsl.onboarding.checkingApt5In": "Sprawdzanie OpenCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie OpenCode...",
  "wsl.onboarding.updatingApt5In": "Aktualizowanie OpenCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateApt5In": "Zaktualizuj OpenCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj OpenCode",
  "wsl.onboarding.apt5ReadyIn": "OpenCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.apt5Ready": "OpenCode jest gotowy.",
  "wsl.onboarding.installApt5In": "Zainstaluj OpenCode w dystrybucji {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCode nie jest zainstalowany",

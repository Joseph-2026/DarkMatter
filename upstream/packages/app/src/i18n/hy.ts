export const dict = {
  ...
  "desktop.menu.documentation": "APT-5 Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "APT-5 մենյու",
  ...
  "desktop.recovery.loadFailed": "APT-5 չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "APT-5 պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "APT-5-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "APT-5 տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.apt5Missing": "apt-5-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.apt5CannotRun": "apt-5-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "APT-5 թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.apt5.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.apt5.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.apt5Go.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են APT-5",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և APT-5-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.apt5Zen.visit.prefix": "Այցելություն ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և APT-5-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և APT-5-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են apt5.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ APT-5 սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է APT-5...",
  "wsl.onboarding.checkingApt5In": "Ստուգում է APT-5-ը {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է APT-5...",
  "wsl.onboarding.updatingApt5In": "Թարմացվում է APT-5-ը {{distro}}...",
  "wsl.onboarding.updateApt5In": "Թարմացնել APT-5-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.apt5Ready": "APT-5 պատրաստ է։",
  "wsl.onboarding.installApt5In": "Տեղադրեք APT-5-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի APT-5-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "APT-5-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք APT-5։",
  ...
  "help.tabs.introduction": "APT-5 Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "APT-5-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին APT-5 թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (apt5.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ APT-5-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "APT-5 ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք APT-5 սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն APT-5",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է APT-5 տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ APT-5-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է APT-5-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ APT-5-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք APT-5-ի վերջին տարբերակը։",

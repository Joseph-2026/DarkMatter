export const dict = {
  ...
  "dialog.provider.apt5.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.apt5.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.apt5Go.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "APT-5n tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja APT-5ssa.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.apt5Zen.visit.prefix": "Avaa ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja APT-5ssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja APT-5ssa.",
  ...
  "dialog.server.description": "Vaihda APT-5-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan APT-5a...",
  "wsl.onboarding.checkingApt5In": "Tarkistetaan APT-5a kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään APT-5a...",
  "wsl.onboarding.updatingApt5In": "Päivitetään APT-5a kohteessa {{distro}}...",
  "wsl.onboarding.updateApt5In": "Päivitä APT-5 jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 on valmis jakelussa {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 on valmis.",
  "wsl.onboarding.installApt5In": "Asenna APT-5 jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5a ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin APT-5 voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "APT-5 ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten APT-5 uudelleen.",
  ...
  "toast.update.description": "APT-5n uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä APT-5-tiimille",
  ...
  "sidebar.gettingStarted.line1": "APT-5 sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita APT-5-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda APT-5n näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä APT-5 näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö APT-5 järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta APT-5n teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun APT-5 käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät APT-5n uusinta versiota.",
  ...
  "desktop.menu.documentation": "APT-5-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "APT-5-valikko",
  ...
  "desktop.recovery.loadFailed": "APT-5n lataaminen epäonnistui",
  "desktop.recovery.terminated": "APT-5-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "APT-5 ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "APT-5n asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.apt5Missing": "apt-5a ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.apt5CannotRun": "apt-5 on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.apt5NotInstalled": "APT-5a ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "APT-5n päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "APT-5 Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":

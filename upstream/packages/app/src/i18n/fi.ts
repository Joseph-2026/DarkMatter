export const dict = {
  ...
  "wsl.onboarding.checkingApt5In": "Tarkistetaan OpenCodea kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään OpenCodea...",
  "wsl.onboarding.updatingApt5In": "Päivitetään OpenCodea kohteessa {{distro}}...",
  "wsl.onboarding.updateApt5In": "Päivitä OpenCode jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä OpenCode",
  "wsl.onboarding.apt5ReadyIn": "OpenCode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.apt5Ready": "OpenCode on valmis.",
  "wsl.onboarding.installApt5In": "Asenna OpenCode jakeluun {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCodea ei ole asennettu",
  ...
  "desktop.wsl.error.apt5Missing": "opencodea ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.apt5CannotRun": "opencode on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.apt5NotInstalled": "OpenCodea ei ole asennettu jakeluun {{distro}}",

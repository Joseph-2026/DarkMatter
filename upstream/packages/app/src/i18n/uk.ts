export const dict = {
  ...
  "desktop.menu.documentation": "Документація APT-5",
  ...
  "desktop.menu.ariaLabel": "Меню APT-5",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити APT-5",
  "desktop.recovery.terminated": "Роботу вікна APT-5 несподівано завершено",
  "desktop.recovery.unresponsive": "APT-5 не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити APT-5",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.apt5Missing": "apt-5 не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.apt5CannotRun": "apt-5 встановлено, але його не вдалося запустити",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення APT-5 завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.apt5.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.apt5.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.apt5Go.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від APT-5",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у APT-5.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в apt5.json",
  ...
  "dialog.server.description": "Перемкніть сервер APT-5, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка APT-5...",
  "wsl.onboarding.checkingApt5In": "Перевірка APT-5 у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення APT-5...",
  "wsl.onboarding.updatingApt5In": "Оновлення APT-5 у {{distro}}...",
  "wsl.onboarding.updateApt5In": "Оновіть APT-5 у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 готовий до роботи у {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 готовий до роботи.",
  "wsl.onboarding.installApt5In": "Встановіть APT-5 у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в APT-5 потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "APT-5 не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте APT-5.",
  ...
  "help.tabs.introduction": "APT-5 Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія APT-5 ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді APT-5",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (apt5.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, APT-5 ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер APT-5 всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу APT-5",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд APT-5 на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи APT-5 використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему APT-5.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску APT-5",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію APT-5.",

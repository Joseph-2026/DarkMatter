export const dict = {
  ...
  "desktop.wsl.error.apt5Missing": "opencode no está instalado en esta distribución",
  "desktop.wsl.error.apt5CannotRun": "opencode está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.apt5NotInstalled": "OpenCode no está instalado en {{distro}}",
  ...
  "wsl.onboarding.checkingApt5In": "Comprobando OpenCode en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando OpenCode...",
  "wsl.onboarding.updatingApt5In": "Actualizando OpenCode en {{distro}}...",
  "wsl.onboarding.updateApt5In": "Actualiza OpenCode en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar OpenCode",
  "wsl.onboarding.apt5ReadyIn": "OpenCode está listo en {{distro}}.",
  "wsl.onboarding.apt5Ready": "OpenCode está listo.",
  "wsl.onboarding.installApt5In": "Instala OpenCode en {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCode no está instalado",

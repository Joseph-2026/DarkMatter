export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de APT-5",
  ...
  "desktop.menu.ariaLabel": "Menú de APT-5",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar APT-5",
  "desktop.recovery.terminated": "La ventana de APT-5 se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "APT-5 no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar APT-5",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.apt5Missing": "apt-5 no está instalado en esta distribución",
  "desktop.wsl.error.apt5CannotRun": "apt-5 está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de APT-5 finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.apt5.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.apt5.tagline": "Modelos optimizados y fiables",
  "dialog.provider.apt5Go.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por APT-5",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.apt5Zen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en APT-5.",
  ...
  "dialog.plugins.empty": "Plugins configurados en apt5.json",
  ...
  "dialog.server.description": "Cambiar el servidor de APT-5 al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando APT-5...",
  "wsl.onboarding.checkingApt5In": "Comprobando APT-5 en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando APT-5...",
  "wsl.onboarding.updatingApt5In": "Actualizando APT-5 en {{distro}}...",
  "wsl.onboarding.updateApt5In": "Actualiza APT-5 en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 está listo en {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 está listo.",
  "wsl.onboarding.installApt5In": "Instala APT-5 en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que APT-5 pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "APT-5 no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir APT-5.",
  ...
  "help.tabs.introduction": "APT-5 Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de APT-5 ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de APT-5",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (apt5.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: APT-5 aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor APT-5 dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para APT-5",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve APT-5 en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si APT-5 sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de APT-5.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia APT-5",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de APT-5.",

...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "APT-5 failed to load",
  "desktop.recovery.terminated": "APT-5 window terminated unexpectedly",
  "desktop.recovery.unresponsive": "APT-5 is not responding",
  ...
  "desktop.wsl.error.installOpencode": "APT-5 installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.apt5Missing": "apt-5 is not installed in this distro",
  "desktop.wsl.error.apt5CannotRun": "apt-5 is installed but could not run",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "APT-5 update finished but {{distro}} still reports {{installed}}; expected {{expected}}",

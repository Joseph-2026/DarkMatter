export const dict = {
  ...
  "desktop.menu.documentation": "APT-5 Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka APT-5",
  ...
  "desktop.recovery.loadFailed": "APT-5 se nepodařilo načíst",
  "desktop.recovery.terminated": "APT-5 okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "APT-5 nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "APT-5 instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.apt5Missing": "apt-5 není v této distribuci nainstalováno",
  "desktop.wsl.error.apt5CannotRun": "apt-5 je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "APT-5 aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.apt5.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.apt5.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.apt5Go.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  "provider.connect.apt5Zen.line2":
    "Pomocí jediného tlačítka API získáte přístup k modelům jako Claude, GPT, Gemini, GLM a dalším.",
  "provider.connect.apt5Zen.visit.prefix": "Návštěva ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v APT-5.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v apt5.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému APT-5 serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola APT-5...",
  "wsl.onboarding.checkingApt5In": "Kontrola APT-5 v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace APT-5...",
  "wsl.onboarding.updatingApt5In": "Aktualizace APT-5 v {{distro}}...",
  "wsl.onboarding.updateApt5In": "Aktualizace APT-5 v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 je připraveno v {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 je připraven.",
  "wsl.onboarding.installApt5In": "Nainstalujte APT-5 do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než APT-5 může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "APT-5 nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete APT-5.",
  ...
  "help.tabs.introduction": "APT-5 Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze APT-5 ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu APT-5",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (apt5.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: APT-5 zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server APT-5 uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro APT-5",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled APT-5 na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude APT-5 následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma APT-5.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění APT-5",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi APT-5.",

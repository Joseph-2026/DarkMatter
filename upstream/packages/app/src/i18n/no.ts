...
export const dict = {
  ...
  "desktop.menu.documentation": "APT-5-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "APT-5-meny",
  ...
  "desktop.recovery.loadFailed": "APT-5 kunne ikke lastes inn",
  "desktop.recovery.terminated": "APT-5-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "APT-5 svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av APT-5 mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.apt5Missing": "apt-5 er ikke installert i denne distribusjonen",
  "desktop.wsl.error.apt5CannotRun": "apt-5 er installert, men kunne ikke kjøres",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av APT-5 er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.apt5.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.apt5.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.apt5Go.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av APT-5",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.apt5Zen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.apt5Zen.visit.prefix": "Besøk ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i APT-5.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i apt5.json",
  ...
  "dialog.server.description": "Bytt hvilken APT-5-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av APT-5 ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til APT-5-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (apt5.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at APT-5 ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør APT-5-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for APT-5",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan APT-5 ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om APT-5 skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i APT-5.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når APT-5 starter",
  ...
  "settings.updates.toast.latest.title": "APT-5 er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av APT-5.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker APT-5...",
  "wsl.onboarding.checkingApt5In": "Sjekker APT-5 i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer APT-5...",
  "wsl.onboarding.updatingApt5In": "Oppdaterer APT-5 i {{distro}}...",
  "wsl.onboarding.updateApt5In": "Oppdater APT-5 i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 er klar i {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 er klar.",
  "wsl.onboarding.installApt5In": "Installer APT-5 i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før APT-5 kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "APT-5 kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter APT-5 på nytt.",
  ...
  "help.tabs.introduction": "APT-5 Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":

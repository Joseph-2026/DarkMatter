export const dict = {
  ...
  "desktop.wsl.error.apt5Missing": "opencode chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.apt5CannotRun": "opencode đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.apt5NotInstalled": "OpenCode chưa được cài đặt trong {{distro}}",
  ...
  "wsl.onboarding.checkingApt5In": "Đang kiểm tra OpenCode trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật OpenCode...",
  "wsl.onboarding.updatingApt5In": "Đang cập nhật OpenCode trong {{distro}}...",
  "wsl.onboarding.updateApt5In": "Cập nhật OpenCode trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật OpenCode",
  "wsl.onboarding.apt5ReadyIn": "OpenCode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.apt5Ready": "OpenCode đã sẵn sàng.",
  "wsl.onboarding.installApt5In": "Cài đặt OpenCode trong {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCode chưa được cài đặt",

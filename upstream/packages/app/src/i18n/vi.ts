export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu APT-5",
  ...
  "desktop.recovery.loadFailed": "Không tải được APT-5",
  "desktop.recovery.terminated": "Cửa sổ APT-5 đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "APT-5 không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được APT-5",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.apt5Missing": "apt-5 chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.apt5CannotRun": "apt-5 đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật APT-5 nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.apt5.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.apt5.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.apt5Go.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do APT-5 cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.apt5Zen.visit.prefix": "Truy cập ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong APT-5.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong apt5.json",
  ...
  "dialog.server.description": "Chuyển máy chủ APT-5 mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra APT-5...",
  "wsl.onboarding.checkingApt5In": "Đang kiểm tra APT-5 trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật APT-5...",
  "wsl.onboarding.updatingApt5In": "Đang cập nhật APT-5 trong {{distro}}...",
  "wsl.onboarding.updateApt5In": "Cập nhật APT-5 trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 đã sẵn sàng.",
  "wsl.onboarding.installApt5In": "Cài đặt APT-5 trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi APT-5 có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "APT-5 không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại APT-5.",
  ...
  "help.tabs.introduction": "APT-5 Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của APT-5 ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm APT-5",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (apt5.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: APT-5 chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ APT-5 bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho APT-5",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của APT-5 trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem APT-5 tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của APT-5.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi APT-5 khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của APT-5.",

export const dict = {
  ...
  "desktop.wsl.error.apt5Missing": "opencode nu este instalat în această distribuție",
  "desktop.wsl.error.apt5CannotRun": "opencode este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.apt5NotInstalled": "OpenCode nu este instalat în {{distro}}",
  ...
  "wsl.onboarding.checkingApt5In": "Se verifică OpenCode în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează OpenCode...",
  "wsl.onboarding.updatingApt5In": "Se actualizează OpenCode în {{distro}}...",
  "wsl.onboarding.updateApt5In": "Actualizează OpenCode în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează OpenCode",
  "wsl.onboarding.apt5ReadyIn": "OpenCode este gata în {{distro}}.",
  "wsl.onboarding.apt5Ready": "OpenCode este gata.",
  "wsl.onboarding.installApt5In": "Instalează OpenCode în {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCode nu este instalat",

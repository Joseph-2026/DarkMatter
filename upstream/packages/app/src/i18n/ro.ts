export const dict = {
  ...
  "desktop.menu.documentation": "Documentație APT-5",
  ...
  "desktop.menu.ariaLabel": "Meniu APT-5",
  ...
  "desktop.recovery.loadFailed": "APT-5 nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra APT-5 s-a închis neașteptat",
  "desktop.recovery.unresponsive": "APT-5 nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea APT-5 a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.apt5Missing": "apt-5 nu este instalat în această distribuție",
  "desktop.wsl.error.apt5CannotRun": "apt-5 este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea APT-5 s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.apt5.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.apt5.tagline": "Modele optimizate, fiabile",
  "dialog.provider.apt5Go.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de APT-5",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.apt5Zen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.apt5Zen.visit.prefix": "Vizitează",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în APT-5.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în apt5.json",
  ...
  "dialog.server.description": "Schimbă serverul APT-5 la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică APT-5...",
  "wsl.onboarding.checkingApt5In": "Se verifică APT-5 în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează APT-5...",
  "wsl.onboarding.updatingApt5In": "Se actualizează APT-5 în {{distro}}...",
  "wsl.onboarding.updateApt5In": "Actualizează APT-5 în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 este gata în {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 este gata.",
  "wsl.onboarding.installApt5In": "Instalează APT-5 în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca APT-5 să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "APT-5 nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide APT-5.",
  ...
  "help.tabs.introduction": "APT-5 Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune APT-5 ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei APT-5",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (apt5.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, APT-5 nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul APT-5 în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru APT-5",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul APT-5 pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă APT-5 urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema APT-5.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea APT-5",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune APT-5.",

export const dict = {
  ...
  "desktop.menu.documentation": "APT-5 دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "APT-5 لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "APT-5 دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "APT-5 جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOpencode": "APT-5 دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.apt5Missing": "اس ڈسٹرو وچ apt-5 انسٹال نئیں اے",
  "desktop.wsl.error.apt5CannotRun": "apt-5 انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.apt5NotInstalled": "{{distro}} وچ APT-5 انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "APT-5 دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.apt5.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.apt5.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.apt5Go.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "APT-5 دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے APT-5 وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.apt5Zen.visit.prefix": "ویکھو ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے APT-5 وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے APT-5 وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "apt5.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس APT-5 سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpencode": "APT-5 چیک کر رئے آں...",
  "wsl.onboarding.checkingApt5In": "{{distro}} چ APT-5 دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpencode": "APT-5 نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingApt5In": "{{distro}} وچ APT-5 نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateApt5In": "{{distro}} وچ APT-5 نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "APT-5 اپ ڈیٹ کرو",
  "wsl.onboarding.apt5ReadyIn": "APT-5 {{distro}} چ تیار اے۔",
  "wsl.onboarding.apt5Ready": "APT-5 تیار اے۔",
  "wsl.onboarding.installApt5In": "{{distro}} وچ APT-5 انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "APT-5 انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "APT-5 دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "APT-5 ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر APT-5 دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "APT-5 Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "APT-5 ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع APT-5 ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (apt5.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، APT-5 ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "APT-5 چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر APT-5 سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "APT-5 لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے APT-5 کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا APT-5 سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "APT-5 نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں APT-5 لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی APT-5 دا تازہ ترین ورژن چلا رئے او۔",

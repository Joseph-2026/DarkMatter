export const dict = {
  ...
  "desktop.recovery.loadFailed": "APT-5 kunde inte läsas in",
  "desktop.recovery.terminated": "APT-5-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "APT-5 svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av APT-5 misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.apt5Missing": "apt-5 är inte installerat i den här distributionen",
  "desktop.wsl.error.apt5CannotRun": "apt-5 är installerat men kunde inte köras",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "APT-5-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.apt5.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.apt5.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.apt5Go.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av APT-5",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  "provider.connect.apt5Zen.line2":
    "Med en enda API-nyckel får du tillgång till modeller som Claude, GPT, Gemini, GLM och mer.",
  "provider.connect.apt5Zen.visit.prefix": "Besök ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i APT-5.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i apt5.json",
  ...
  "dialog.server.description": "Växla vilken APT-5-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar APT-5...",
  "wsl.onboarding.checkingApt5In": "Kontrollerar APT-5 i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar APT-5...",
  "wsl.onboarding.updatingApt5In": "Uppdaterar APT-5 i {{distro}}...",
  "wsl.onboarding.updateApt5In": "Uppdatera APT-5 i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 är redo i {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 är redo.",
  "wsl.onboarding.installApt5In": "Installera APT-5 i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan APT-5 kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "APT-5 kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan APT-5 igen.",
  ...
  "help.tabs.introduction": "APT-5 Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av APT-5 ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till APT-5-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (apt5.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, APT-5 stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör APT-5-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för APT-5",
  ...
  "settings.general.row.appearance.description": "Anpassa hur APT-5 ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om APT-5 följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa APT-5s tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när APT-5 startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av APT-5.",

export const dict = {
  ...
  "desktop.menu.documentation": "APT-5 hujjatlari",
  ...
  "desktop.menu.ariaLabel": "APT-5 menyusi",
  ...
  "desktop.recovery.loadFailed": "APT-5 yuklanmadi",
  "desktop.recovery.terminated": "APT-5 oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "APT-5 javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "APT-5 oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.apt5Missing": "Opencode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.apt5CannotRun": "apt-5 o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "APT-5 yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.apt5.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.apt5.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.apt5Go.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "APT-5 tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va APT-5’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.apt5Zen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va APT-5 da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va APT-5 da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "apt5.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi APT-5 serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "APT-5 tekshirilmoqda...",
  "wsl.onboarding.checkingApt5In": "APT-5 {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "APT-5 yangilanmoqda...",
  "wsl.onboarding.updatingApt5In": "APT-5 {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateApt5In": "APT-5-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "APT-5-ni yangilang",
  "wsl.onboarding.apt5ReadyIn": "APT-5 {{distro}} da tayyor.",
  "wsl.onboarding.apt5Ready": "APT-5 tayyor.",
  "wsl.onboarding.installApt5In": "APT-5-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "APT-5-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "APT-5 WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "APT-5 WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra APT-5-ni qayta oching.",
  ...
  "help.tabs.introduction": "APT-5 Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "APT-5 ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida APT-5 jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (apt5.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, APT-5 hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "APT-5 bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi APT-5 serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "APT-5 uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "APT-5 qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "APT-5 tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "APT-5 mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "APT-5 ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz APT-5 oxirgi versiyasini ishga tushiryapsiz.",

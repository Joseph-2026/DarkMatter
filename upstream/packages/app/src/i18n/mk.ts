export const dict = {
  ...
  "desktop.menu.documentation": "APT-5 Документација",
  ...
  "desktop.menu.ariaLabel": "APT-5 мени",
  ...
  "desktop.recovery.loadFailed": "APT-5 не успеа да се вчита",
  "desktop.recovery.terminated": "Прозорецот APT-5 неочекувано заврши",
  "desktop.recovery.unresponsive": "APT-5 не реагира",
  ...
  "desktop.wsl.error.installOpencode": "инсталацијата APT-5 не успеа",
  "desktop.wsl.error.alreadyAdded": "{{distro}} е веќе додаден",
  "desktop.wsl.error.apt5Missing": "apt-5 не е инсталиран во оваа дистрибуција",
  "desktop.wsl.error.apt5CannotRun": "apt-5 е инсталиран, но не може да се изврши",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 не е инсталиран во {{distro}}",
  "desktop.wsl.error.updateVersion":
    "APT-5 ажурирањето е завршено, но {{distro}} сè уште известува {{installed}}; се очекува {{expected}}",
  ...
  "dialog.provider.apt5.note": "Курирани модели вклучувајќи Claude, GPT, Gemini и повеќе",
  "dialog.provider.apt5.tagline": "Сигурни оптимизирани модели",
  "dialog.provider.apt5Go.tagline": "Ниска цена претплата за секого",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатни модели обезбедени од APT-5",
  ...
  "provider.connect.apiKey.description":
    "Внесете го вашиот клуч {{provider}} API за да ја поврзете вашата сметка и да користите {{provider}} модели во APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen ви дава пристап до куриран сет на сигурни оптимизирани модели за агенти за кодирање.",
  "provider.connect.apt5Zen.line2":
    "Со еден клуч API ќе добиете пристап до модели како што се Claude, GPT, Gemini, GLM и повеќе.",
  "provider.connect.apt5Zen.visit.prefix": "Посетете",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": "да го соберете вашиот клуч API.",
  "provider.connect.oauth.code.visit.prefix": "Посетете",
  "provider.connect.oauth.code.visit.link": "оваа врска",
  "provider.connect.oauth.code.visit.suffix":
    "да го соберете вашиот код за авторизација за да ја поврзете вашата сметка и да користите {{provider}} модели во APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и внесете го кодот подолу за да ја поврзете вашата сметка и да користите {{provider}} модели во APT-5.",
  ...
  "dialog.plugins.empty": "Приклучоци конфигурирани во apt5.json",
  ...
  "dialog.server.description": "Променете на кој APT-5 сервер се поврзува оваа апликација.",
  ...
  "wsl.onboarding.checkingOpencode": "Се проверува APT-5...",
  "wsl.onboarding.checkingApt5In": "Се проверува APT-5 во {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Се ажурира APT-5...",
  "wsl.onboarding.updatingApt5In": "Се ажурира APT-5 во {{distro}}...",
  "wsl.onboarding.updateApt5In": "Ажурирајте APT-5 во {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ажурирај APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 е подготвен во {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 е подготвен.",
  "wsl.onboarding.installApt5In": "Инсталирајте APT-5 во {{distro}}.",
  "wsl.onboarding.installOpencode": "Инсталирај APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 не е инсталиран",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) е потребно пред APT-5 да може да додаде WSL сервер",
  "wsl.onboarding.wslUnavailable.title": "WSL недостапен",
  "wsl.onboarding.wslUnavailable.description": "APT-5 не можеше да го потврди WSL на оваа машина.",
  "wsl.onboarding.installWsl": "Инсталирај WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирајте го Windows за да завршите со инсталирањето WSL, а потоа повторно отворете APT-5.",
  ...
  "help.tabs.introduction": "APT-5 Desktop сега е изграден околу картичките.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новата верзија на APT-5 ({{version}}) сега е достапна за инсталирање.",
  ...
  "error.page.report.prefix": "Ве молиме пријавете ја оваа грешка на тимот APT-5",
  ...
  "error.chain.checkConfig": "Проверете ги имињата на давателот/моделот за конфигурација (apt5.json).",
  "error.chain.mcpFailed":
    "MCP серверот „{{name}}“ не успеа. Забелешка, APT-5 сè уште не поддржува автентикација MCP.",
  ...
  "sidebar.gettingStarted.line1": "APT-5 вклучува бесплатни модели за да можете веднаш да започнете.",
  ...
  "settings.desktop.wsl.description": "Стартувај го серверот APT-5 во WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете го јазикот на прикажување за APT-5",
  ...
  "settings.general.row.appearance.description": "Приспособете како изгледа APT-5 на вашиот уред",
  "settings.general.row.colorScheme.title": "Шема на бои",
  "settings.general.row.colorScheme.description": "Изберете дали APT-5 ја следи системската, светла или темна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Приспособете како APT-5 е тематизирана.",
  ...
  "settings.updates.row.startup.description": "Автоматски проверувајте дали има ажурирања кога ќе се стартува APT-5",
  ...
  "settings.updates.toast.latest.description": "Ја извршувате најновата верзија на APT-5.",

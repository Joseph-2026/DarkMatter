...
const desktop = [
  ...
  "Kilépés",
  "Az APT-5 betöltése sikertelen",
  "Az APT-5 ablaka váratlanul leállt",
  "Az APT-5 nem válaszol",
  ...
  "Az APT-5 telepítése sikertelen",
  "A(z) {{distro}} már hozzá van adva",
  "Az apt-5 nincs telepítve ebben a disztribúcióban",
  "Az apt-5 telepítve van, de nem futtatható",
  "Az APT-5 nincs telepítve ebben: {{distro}}",
  "Az APT-5 frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.apt5.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.apt5.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.apt5Go.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.unpaid.freeModels.title": "A APT-5 ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a APT-5-ben.",
  ...
  "provider.connect.apt5Zen.line1":
    "A APT-5 Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.apt5Zen.visit.prefix": "Látogatás",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a APT-5-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a APT-5-ben.",
  ...
  "dialog.plugins.empty": "Az apt5.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik APT-5 szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingOpencode": "APT-5 ellenőrzése...",
  "wsl.onboarding.checkingApt5In": "APT-5 ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingOpencode": "APT-5 frissítése...",
  "wsl.onboarding.updatingApt5In": "APT-5 frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateApt5In": "Frissítse a APT-5-t a {{distro}}-ben.",
  "wsl.onboarding.updateOpencode": "Frissítse a APT-5-t",
  "wsl.onboarding.apt5ReadyIn": "A APT-5 készen áll a {{distro}}-ben.",
  "wsl.onboarding.apt5Ready": "A APT-5 készen áll.",
  "wsl.onboarding.installApt5In": "Telepítse a APT-5-t a {{distro}}-be.",
  "wsl.onboarding.installOpencode": "Telepítse a APT-5-t",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "A APT-5 nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a APT-5 hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A APT-5 nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a APT-5 programot.",
  ...
  "help.tabs.introduction": "A APT-5 Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A APT-5 ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a APT-5 csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (apt5.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a APT-5 még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A APT-5 ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "APT-5 asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a APT-5 szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a APT-5 kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a APT-5 az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a APT-5 a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a APT-5 témáját.",
  ...
  "settings.updates.row.startup.description": "A APT-5 indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a APT-5 legújabb verzióját futtatja.",

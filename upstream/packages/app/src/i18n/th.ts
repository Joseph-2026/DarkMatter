export const dict = {
  ...
  "desktop.wsl.error.apt5Missing": "ไม่ได้ติดตั้ง opencode ในดิสโทรนี้",
  "desktop.wsl.error.apt5CannotRun": "ติดตั้ง opencode แล้ว แต่ไม่สามารถเรียกใช้ได้",
  "desktop.wsl.error.apt5NotInstalled": "ไม่ได้ติดตั้ง OpenCode ใน {{distro}}",
  ...
  "wsl.onboarding.checkingApt5In": "กำลังตรวจสอบ OpenCode ใน {{distro}}...",
  "wsl.onboarding.updatingOpencode": "กำลังอัปเดต OpenCode...",
  "wsl.onboarding.updatingApt5In": "กำลังอัปเดต OpenCode ใน {{distro}}...",
  "wsl.onboarding.updateApt5In": "อัปเดต OpenCode ใน {{distro}}",
  "wsl.onboarding.updateOpencode": "อัปเดต OpenCode",
  "wsl.onboarding.apt5ReadyIn": "OpenCode พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.apt5Ready": "OpenCode พร้อมใช้งานแล้ว",
  "wsl.onboarding.installApt5In": "ติดตั้ง OpenCode ใน {{distro}}",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "ยังไม่ได้ติดตั้ง OpenCode",

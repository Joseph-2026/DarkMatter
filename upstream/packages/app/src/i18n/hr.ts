...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "APT-5 se nije uspio učitati",
  "Prozor aplikacije APT-5 neočekivano je zatvoren",
  "APT-5 ne reagira",
  ...
  "Instalacija aplikacije APT-5 nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "apt-5 nije instaliran u ovoj distribuciji",
  "apt-5 je instaliran, ali se ne može pokrenuti",
  "APT-5 nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije APT-5 je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.apt5.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.apt5.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.apt5Go.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi APT-5",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.apt5Zen.visit.prefix": "Posjetiti",
  "provider.connect.apt5Zen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.apt5Zen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u APT-5.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u apt5.json",
  ...
  "dialog.server.description": "Promijenite na koji se APT-5 poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingApt5In": "Provjera APT-5 u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje APT-5...",
  "wsl.onboarding.updatingApt5In": "Ažuriranje APT-5 u {{distro}}...",
  "wsl.onboarding.updateApt5In": "Ažurirajte APT-5 u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 je spreman u {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 je spreman.",
  "wsl.onboarding.installApt5In": "Instalirajte APT-5 u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte APT-5",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što APT-5 može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "APT-5 nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite APT-5.",
  ...
  "help.tabs.introduction": "Radna površina APT-5 sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija APT-5 ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku APT-5 timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (apt5.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, APT-5 još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "APT-5 Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite APT-5 poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za APT-5",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako APT-5 izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li APT-5 slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je APT-5 tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se APT-5 pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju APT-5.",

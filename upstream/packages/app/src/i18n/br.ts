export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do APT-5",
  ...
  "desktop.menu.ariaLabel": "Menu do APT-5",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o APT-5",
  "desktop.recovery.terminated": "A janela do APT-5 foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O APT-5 não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do APT-5",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.apt5Missing": "O apt-5 não está instalado nesta distribuição",
  "desktop.wsl.error.apt5CannotRun": "O apt-5 está instalado, mas não pôde ser executado",
  "desktop.wsl.error.apt5NotInstalled": "O APT-5 não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do APT-5 foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.apt5.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.apt5.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.apt5Go.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo APT-5",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.apt5Zen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.apt5Zen.visit.prefix": "Visite ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no APT-5.",
  ...
  "dialog.plugins.empty": "Plugins configurados em apt5.json",
  ...
  "dialog.server.description": "Trocar para qual servidor APT-5 este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o APT-5...",
  "wsl.onboarding.checkingApt5In": "Verificando o APT-5 em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o APT-5...",
  "wsl.onboarding.updatingApt5In": "Atualizando o APT-5 em {{distro}}...",
  "wsl.onboarding.updateApt5In": "Atualize o APT-5 em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o APT-5",
  "wsl.onboarding.apt5ReadyIn": "O APT-5 está pronto em {{distro}}.",
  "wsl.onboarding.apt5Ready": "O APT-5 está pronto.",
  "wsl.onboarding.installApt5In": "Instale o APT-5 em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o APT-5 possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O APT-5 não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o APT-5 novamente.",
  ...
  "help.tabs.introduction": "Agora, o APT-5 Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do APT-5 ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do APT-5",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (apt5.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: APT-5 ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor APT-5 dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do APT-5",
  ...
  "settings.general.row.appearance.description": "Personalize como o APT-5 aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o APT-5 segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o APT-5 é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o APT-5 iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do APT-5.",

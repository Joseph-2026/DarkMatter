export const dict = {
  ...
  "desktop.wsl.error.apt5Missing": "O opencode não está instalado nesta distribuição",
  "desktop.wsl.error.apt5CannotRun": "O opencode está instalado, mas não pôde ser executado",
  "desktop.wsl.error.apt5NotInstalled": "O OpenCode não está instalado em {{distro}}",
  ...
  "wsl.onboarding.checkingApt5In": "Verificando o OpenCode em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o OpenCode...",
  "wsl.onboarding.updatingApt5In": "Atualizando o OpenCode em {{distro}}...",
  "wsl.onboarding.updateApt5In": "Atualize o OpenCode em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o OpenCode",
  "wsl.onboarding.apt5ReadyIn": "O OpenCode está pronto em {{distro}}.",
  "wsl.onboarding.apt5Ready": "O OpenCode está pronto.",
  "wsl.onboarding.installApt5In": "Instale o OpenCode em {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCode não instalado",

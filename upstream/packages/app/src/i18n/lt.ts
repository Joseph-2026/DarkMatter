...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "APT-5 įkelti nepavyko",
  "APT-5 langas netikėtai užsidarė",
  "APT-5 neatsako",
  ...
  "APT-5 įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "apt-5 šiame distributyve neįdiegtas",
  "apt-5 įdiegtas, bet jo paleisti nepavyko",
  "APT-5 neįdiegtas distributyve {{distro}}",
  "APT-5 naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.apt5.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.apt5.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.apt5Go.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami APT-5 modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  "provider.connect.apt5Zen.line2":
    "Su vienu API raktu galėsite pasiekti tokius modelius kaip Claude, GPT, Gemini, GLM ir kt.",
  "provider.connect.apt5Zen.visit.prefix": "Aplankykite",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius APT-5.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti apt5.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio APT-5 serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama APT-5...",
  "wsl.onboarding.checkingApt5In": "Tikrinama APT-5 {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas APT-5...",
  "wsl.onboarding.updatingApt5In": "Atnaujinamas APT-5 {{distro}}...",
  "wsl.onboarding.updateApt5In": "Atnaujinkite APT-5 {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 yra paruoštas {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 yra paruoštas.",
  "wsl.onboarding.installApt5In": "Įdiekite APT-5 į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad APT-5 galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "APT-5 nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite APT-5.",
  ...
  "help.tabs.introduction": "APT-5 Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują APT-5 ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą APT-5 komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (apt5.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad APT-5 dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "APT-5 apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "APT-5 darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite APT-5 serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite APT-5 ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip APT-5 atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar APT-5 seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite APT-5 temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas APT-5",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią APT-5 versiją.",

export const dict = {
  ...
  "dialog.provider.apt5.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.apt5.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.apt5Go.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da APT-5",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.apt5Zen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.apt5Zen.visit.prefix": "Visita ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in APT-5.",
  ...
  "dialog.plugins.empty": "Plugin configurati in apt5.json",
  ...
  "dialog.server.description": "Cambia il server APT-5 a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo APT-5...",
  "wsl.onboarding.checkingApt5In": "Controllo APT-5 in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento APT-5...",
  "wsl.onboarding.updatingApt5In": "Aggiornamento APT-5 in {{distro}}...",
  "wsl.onboarding.updateApt5In": "Aggiorna APT-5 in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 è pronto in {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 è pronto.",
  "wsl.onboarding.installApt5In": "Installa APT-5 in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che APT-5 possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "APT-5 non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri APT-5.",
  ...
  "help.tabs.introduction": "APT-5 Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di APT-5 ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team APT-5",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (apt5.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: APT-5 non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server APT-5 all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per APT-5",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di APT-5 sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se APT-5 segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di APT-5.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di APT-5",
  ...
  "settings.updates.toast.latest.title": "APT-5 è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di APT-5.",
  ...
  "desktop.menu.documentation": "Documentazione di APT-5",
  ...
  "desktop.menu.ariaLabel": "Menu APT-5",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare APT-5",
  "desktop.recovery.terminated": "La finestra di APT-5 si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "APT-5 non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di APT-5 non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.apt5Missing": "apt-5 non è installato in questa distribuzione",
  "desktop.wsl.error.apt5CannotRun": "apt-5 è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di APT-5 è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",

export const dict = {
  ...
  "desktop.menu.documentation": "APT-5 Документация",
  ...
  "desktop.recovery.loadFailed": "APT-5 не успя да се зареди",
  "desktop.recovery.terminated": "Прозорецът APT-5 приключи неочаквано",
  "desktop.recovery.unresponsive": "APT-5 не отговаря",
  ...
  "desktop.wsl.error.installOpencode": "Инсталирането на APT-5 е неуспешно",
  "desktop.wsl.error.alreadyAdded": "{{distro}} вече е добавен",
  "desktop.wsl.error.apt5Missing": "apt-5 не е инсталиран в тази дистрибуция",
  "desktop.wsl.error.apt5CannotRun": "apt-5 е инсталиран, но не може да стартира",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 не е инсталиран в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "APT-5 актуализацията приключи, но {{distro}} все още съобщава {{installed}}; очаквано {{expected}}",
  ...
  "dialog.provider.apt5.note": "Подбрани модели, включително Claude, GPT, Gemini и други",
  "dialog.provider.apt5.tagline": "Надеждни оптимизирани модели",
  "dialog.provider.apt5Go.tagline": "Абонамент на ниска цена за всеки",
  ...
  "dialog.model.unpaid.freeModels.title": "Безплатни модели, предоставени от APT-5",
  ...
  "provider.connect.apiKey.description":
    "Въведете своя {{provider}} API ключ, за да свържете акаунта си и да използвате {{provider}} модели в APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen ви дава достъп до подбран набор от надеждни оптимизирани модели за кодиращи агенти.",
  ...
  "provider.connect.apt5Zen.visit.suffix": "за да вземете своя ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Посетете",
  "provider.connect.oauth.code.visit.link": "тази връзка",
  "provider.connect.oauth.code.visit.suffix":
    "за да вземете вашия код за оторизация, за да свържете акаунта си и да използвате {{provider}} модели в APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и въведете кода по-долу, за да свържете акаунта си и да използвате {{provider}} модели в APT-5.",
  ...
  "dialog.plugins.empty": "Добавки, конфигурирани в apt5.json",
  ...
  "dialog.server.description": "Превключете към кой APT-5 сървър се свързва това приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверява се APT-5...",
  "wsl.onboarding.checkingApt5In": "Проверява се APT-5 в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Актуализиране на APT-5...",
  "wsl.onboarding.updatingApt5In": "Актуализиране на APT-5 в {{distro}}...",
  "wsl.onboarding.updateApt5In": "Актуализирайте APT-5 в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Актуализация APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 е готов в {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 е готов.",
  "wsl.onboarding.installApt5In": "Инсталирайте APT-5 в {{distro}}.",
  "wsl.onboarding.installOpencode": "Инсталирайте APT-5",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) се изисква, преди APT-5 да може да добави WSL сървър",
  "wsl.onboarding.wslUnavailable.title": "WSL не е наличен",
  "wsl.onboarding.wslUnavailable.description": "APT-5 не можа да провери WSL на тази машина.",
  "wsl.onboarding.installWsl": "Инсталирайте WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирайте Windows, за да завършите инсталирането на WSL, след което отворете отново APT-5.",
  ...
  "help.tabs.introduction": "APT-5 Desktop вече е изграден около раздели.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Вече е достъпна за инсталиране нова версия на APT-5 ({{version}}).",
  ...
  "error.page.report.prefix": "Моля, докладвайте тази грешка на екипа на APT-5",
  ...
  "error.chain.checkConfig": "Проверете имената на доставчика/модела на вашата конфигурация (apt5.json).",
  "error.chain.mcpFailed":
    'MCP сървър "{{name}}" не успя. Имайте предвид, че APT-5 все още не поддържа MCP удостоверяване.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 включва безплатни модели, така че можете да започнете веднага.",
  ...
  "settings.desktop.wsl.description": "Стартирайте сървъра APT-5 вътре в WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете езика на дисплея за APT-5",
  ...
  "settings.general.row.appearance.description": "Персонализирайте как изглежда APT-5 на вашето устройство",
  "settings.general.row.colorScheme.title": "Цветова схема",
  "settings.general.row.colorScheme.description": "Изберете дали APT-5 следва системната, светла или тъмна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Персонализирайте как е тематично APT-5.",
  ...
  "settings.updates.row.startup.description": "Автоматично проверявайте за актуализации при стартиране на APT-5",
  ...
  "settings.updates.toast.latest.description": "Вие използвате най-новата версия на APT-5.",

...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða APT-5",
  "APT-5-glugganum var óvænt lokað",
  "APT-5 svarar ekki",
  ...
  "Uppsetning APT-5 mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "apt-5 er ekki uppsett í þessari dreifingu",
  "apt-5 er uppsett en ekki var hægt að keyra það",
  "APT-5 er ekki uppsett í {{distro}}",
  "Uppfærslu APT-5 lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.apt5.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.apt5.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.apt5Go.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá APT-5",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.apt5Zen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.apt5Zen.visit.prefix": "Heimsókn",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í APT-5.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í apt5.json",
  ...
  "dialog.server.description": "Skiptu um hvaða APT-5 miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar APT-5...",
  "wsl.onboarding.checkingApt5In": "Athugar APT-5 í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir APT-5...",
  "wsl.onboarding.updatingApt5In": "Uppfærir APT-5 í {{distro}}...",
  "wsl.onboarding.updateApt5In": "Uppfærðu APT-5 í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 er tilbúið í {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 er tilbúinn.",
  "wsl.onboarding.installApt5In": "Settu upp APT-5 í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en APT-5 getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "APT-5 gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan APT-5 aftur.",
  ...
  "help.tabs.introduction": "APT-5 Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af APT-5 ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til APT-5 teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (apt5.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, APT-5 styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "APT-5 inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "APT-5 skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu APT-5 netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir APT-5",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig APT-5 lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort APT-5 fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig APT-5 er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar APT-5 ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af APT-5.",

export const dict = {
  ...
  "dialog.provider.apt5.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.apt5.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.apt5Go.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af APT-5",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.apt5Zen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.apt5Zen.visit.prefix": "Besøg ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i APT-5.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i apt5.json",
  ...
  "dialog.server.description": "Skift hvilken APT-5-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker APT-5...",
  "wsl.onboarding.checkingApt5In": "Tjekker APT-5 i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer APT-5...",
  "wsl.onboarding.updatingApt5In": "Opdaterer APT-5 i {{distro}}...",
  "wsl.onboarding.updateApt5In": "Opdater APT-5 i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før APT-5 kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "APT-5 kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter APT-5 igen.",
  ...
  "toast.update.description": "En ny version af APT-5 ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til APT-5-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (apt5.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, APT-5 understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør APT-5-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for APT-5",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan APT-5 ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om APT-5 skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas APT-5s tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når APT-5 starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af APT-5.",
  ...
  "desktop.recovery.loadFailed": "APT-5 kunne ikke indlæses",
  "desktop.recovery.terminated": "APT-5-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af APT-5 mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.apt5Missing": "apt-5 er ikke installeret i denne distribution",
  "desktop.wsl.error.apt5CannotRun": "apt-5 er installeret, men kunne ikke køre",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af APT-5 er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "APT-5 Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":

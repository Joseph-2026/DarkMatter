export const dict = {
  ...
  "desktop.wsl.error.apt5Missing": "opencode ບໍ່ໄດ້ຕິດຕັ້ງຢູ່ໃນ distro ນີ້",
  "desktop.wsl.error.apt5CannotRun": "opencode ຖືກຕິດຕັ້ງແຕ່ບໍ່ສາມາດດໍາເນີນການໄດ້",
  "desktop.wsl.error.apt5NotInstalled": "OpenCode ບໍ່ໄດ້ຕິດຕັ້ງຢູ່ໃນ {{distro}}",
  ...
  "wsl.onboarding.checkingApt5In": "ກຳລັງກວດສອບ OpenCode ໃນ {{distro}}...",
  "wsl.onboarding.updatingOpencode": "ກຳລັງອັບເດດ OpenCode...",
  "wsl.onboarding.updatingApt5In": "ກຳລັງອັບເດດ OpenCode ໃນ {{distro}}...",
  "wsl.onboarding.updateApt5In": "ອັບເດດ OpenCode ໃນ {{distro}}.",
  "wsl.onboarding.updateOpencode": "ອັບເດດ OpenCode",
  "wsl.onboarding.apt5ReadyIn": "OpenCode ແມ່ນພ້ອມແລ້ວໃນ {{distro}}.",
  "wsl.onboarding.apt5Ready": "OpenCode ພ້ອມແລ້ວ.",
  "wsl.onboarding.installApt5In": "ຕິດຕັ້ງ OpenCode ໃນ {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCode ບໍ່ໄດ້ຕິດຕັ້ງ",

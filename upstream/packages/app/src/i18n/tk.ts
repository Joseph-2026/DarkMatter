export const dict = {
  ...
  "desktop.menu.documentation": "APT-5 Resminamalar",
  ...
  "desktop.menu.ariaLabel": "APT-5 menýusy",
  ...
  "desktop.recovery.loadFailed": "APT-5 ýükläp bilmedi",
  "desktop.recovery.terminated": "APT-5 penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "APT-5 jogap berenok",
  ...
  "desktop.wsl.error.installOpencode": "APT-5 gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.apt5Missing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.apt5CannotRun": "apt-5 guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "APT-5 täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.apt5.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.apt5.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.apt5Go.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "APT-5 tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we APT-5-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  "provider.connect.apt5Zen.line2":
    "Zekeje API açary bilen Claude, GPT, Gemini, GLM we başgalar ýaly modellere girip bilersiňiz.",
  "provider.connect.apt5Zen.visit.prefix": "Sapar ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini APT-5-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini APT-5-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "apt5.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy APT-5 serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOpencode": "APT-5 barlamak ...",
  "wsl.onboarding.checkingApt5In": "{{distro}} içinde APT-5 barlanýar...",
  "wsl.onboarding.updatingOpencode": "APT-5 täzelenmek ...",
  "wsl.onboarding.updatingApt5In": "{{distro}}-de APT-5 täzelenmek ...",
  "wsl.onboarding.updateApt5In": "APT-5-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOpencode": "APT-5 täzeläň",
  "wsl.onboarding.apt5ReadyIn": "APT-5 {{distro}}-de taýýar.",
  "wsl.onboarding.apt5Ready": "APT-5 taýýar.",
  "wsl.onboarding.installApt5In": "{{distro}}-de APT-5 guruň.",
  "wsl.onboarding.installOpencode": "APT-5 guruň",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) APT-5 WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "APT-5 bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra APT-5 açyň.",
  ...
  "help.tabs.introduction": "APT-5 Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin APT-5 ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy APT-5 toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (apt5.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, APT-5 entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "APT-5 serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "APT-5 üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "APT-5 enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "APT-5 ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "APT-5-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "APT-5 işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "APT-5-iň iň soňky wersiýasyny işleýärsiňiz.",

...
export const dict = {
  ...
  "desktop.wsl.error.apt5Missing": "opencode bu dağıtımda kurulu değil",
  "desktop.wsl.error.apt5CannotRun": "opencode kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.apt5NotInstalled": "OpenCode, {{distro}} içinde kurulu değil",
  ...
  "wsl.onboarding.checkingApt5In": "{{distro}} içinde OpenCode kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "OpenCode güncelleniyor...",
  "wsl.onboarding.updatingApt5In": "{{distro}} içinde OpenCode güncelleniyor...",
  "wsl.onboarding.updateApt5In": "{{distro}} içindeki OpenCode'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "OpenCode'u güncelle",
  "wsl.onboarding.apt5ReadyIn": "{{distro}} içinde OpenCode hazır.",
  "wsl.onboarding.apt5Ready": "OpenCode hazır.",
  "wsl.onboarding.installApt5In": "OpenCode'u {{distro}} içine kurun.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCode kurulu değil",

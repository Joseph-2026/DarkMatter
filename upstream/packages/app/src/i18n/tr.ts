...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "APT-5 yüklenemedi",
  "desktop.recovery.terminated": "APT-5 penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "APT-5 yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "APT-5 kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.apt5Missing": "apt-5 bu dağıtımda kurulu değil",
  "desktop.wsl.error.apt5CannotRun": "apt-5 kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.apt5NotInstalled": "APT-5, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "APT-5 güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.apt5.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.apt5.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.apt5Go.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "APT-5 tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve APT-5'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.apt5Zen.visit.prefix": "",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak APT-5'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak APT-5'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler apt5.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi APT-5 sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "APT-5 kontrol ediliyor...",
  "wsl.onboarding.checkingApt5In": "{{distro}} içinde APT-5 kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "APT-5 güncelleniyor...",
  "wsl.onboarding.updatingApt5In": "{{distro}} içinde APT-5 güncelleniyor...",
  "wsl.onboarding.updateApt5In": "{{distro}} içindeki APT-5'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "APT-5'u güncelle",
  "wsl.onboarding.apt5ReadyIn": "{{distro}} içinde APT-5 hazır.",
  "wsl.onboarding.apt5Ready": "APT-5 hazır.",
  "wsl.onboarding.installApt5In": "APT-5'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "APT-5'u kur",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "APT-5'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "APT-5 bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından APT-5'u tekrar açın.",
  ...
  "help.tabs.introduction": "APT-5 Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "APT-5'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı APT-5 ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (apt5.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: APT-5 henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "APT-5 Masaüstü",
  ...
  "settings.desktop.wsl.description": "APT-5 sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "APT-5'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "APT-5'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "APT-5'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "APT-5'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "APT-5 başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "APT-5'un en son sürümünü kullanıyorsunuz.",

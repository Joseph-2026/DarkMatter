export const dict = {
  ...
  "desktop.wsl.error.apt5Missing": "opencode tidak dipasang dalam distro ini",
  "desktop.wsl.error.apt5CannotRun": "opencode dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.apt5NotInstalled": "OpenCode tidak dipasang dalam {{distro}}",
  ...
  "wsl.onboarding.checkingApt5In": "Sedang menyemak OpenCode dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini OpenCode...",
  "wsl.onboarding.updatingApt5In": "Sedang mengemas kini OpenCode dalam {{distro}}...",
  "wsl.onboarding.updateApt5In": "Kemas kini OpenCode dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini OpenCode",
  "wsl.onboarding.apt5ReadyIn": "OpenCode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.apt5Ready": "OpenCode sedia digunakan.",
  "wsl.onboarding.installApt5In": "Pasang OpenCode dalam {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCode belum dipasang",

export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi APT-5",
  ...
  "desktop.recovery.loadFailed": "APT-5 gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap APT-5 ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "APT-5 tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan APT-5 gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.apt5Missing": "apt-5 tidak dipasang dalam distro ini",
  "desktop.wsl.error.apt5CannotRun": "apt-5 dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini APT-5 selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.apt5.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.apt5.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.apt5Go.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh APT-5",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.apt5Zen.visit.prefix": "Layari",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam APT-5.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam apt5.json",
  ...
  "dialog.server.description": "Tukar pelayan APT-5 yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak APT-5...",
  "wsl.onboarding.checkingApt5In": "Sedang menyemak APT-5 dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini APT-5...",
  "wsl.onboarding.updatingApt5In": "Sedang mengemas kini APT-5 dalam {{distro}}...",
  "wsl.onboarding.updateApt5In": "Kemas kini APT-5 dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 sedia digunakan.",
  "wsl.onboarding.installApt5In": "Pasang APT-5 dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum APT-5 boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "APT-5 tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula APT-5.",
  ...
  "help.tabs.introduction": "APT-5 Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu APT-5 ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan APT-5",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (apt5.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, APT-5 belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan APT-5 dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk APT-5",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa APT-5 pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada APT-5 mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema APT-5.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila APT-5 dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini APT-5.",

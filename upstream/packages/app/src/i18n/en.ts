...
export const dict = {
  ...
  "dialog.provider.apt5.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.apt5.tagline": "Reliable optimized models",
  "dialog.provider.apt5Go.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by APT-5",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in APT-5.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.apt5Zen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.apt5Zen.visit.prefix": "Visit ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in APT-5.",
  ...
  "dialog.plugins.empty": "Plugins configured in apt5.json",
  ...
  "dialog.server.description": "Switch which APT-5 server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking APT-5...",
  "wsl.onboarding.checkingApt5In": "Checking APT-5 in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating APT-5...",
  "wsl.onboarding.updatingApt5In": "Updating APT-5 in {{distro}}...",
  "wsl.onboarding.updateApt5In": "Update APT-5 in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 is ready in {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 is ready.",
  "wsl.onboarding.installApt5In": "Install APT-5 in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before APT-5 can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "APT-5 could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen APT-5.",
  ...
  "help.tabs.introduction": "APT-5 Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of APT-5 ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the APT-5 team",
  ...
  "error.chain.checkConfig": "Check your config (apt5.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, APT-5 does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the APT-5 server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for APT-5",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how APT-5 looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether APT-5 follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how APT-5 is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when APT-5 launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of APT-5.",

...
export const dict = {
  ...
  "wsl.onboarding.checkingApt5In": "Checking OpenCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating OpenCode...",
  "wsl.onboarding.updatingApt5In": "Updating OpenCode in {{distro}}...",
  "wsl.onboarding.updateApt5In": "Update OpenCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update OpenCode",
  "wsl.onboarding.apt5ReadyIn": "OpenCode is ready in {{distro}}.",
  "wsl.onboarding.apt5Ready": "OpenCode is ready.",
  "wsl.onboarding.installApt5In": "Install OpenCode in {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCode not installed",

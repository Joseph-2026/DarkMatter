export const dict = {
  ...
  "desktop.menu.documentation": "APT-5-documentatie",
  ...
  "desktop.recovery.loadFailed": "APT-5 kan niet worden geladen",
  "desktop.recovery.terminated": "Het APT-5-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "APT-5 reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van APT-5 is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.apt5Missing": "apt-5 is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.apt5CannotRun": "apt-5 is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De APT-5-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.apt5.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.apt5.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.apt5Go.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door APT-5",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in APT-5 te gebruiken.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.apt5Zen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.apt5Zen.visit.prefix": "Ga naar ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in APT-5 te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in APT-5 te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in apt5.json",
  ...
  "dialog.server.description": "Wijzig met welke APT-5-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "APT-5 controleren...",
  "wsl.onboarding.checkingApt5In": "APT-5 controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "APT-5 bijwerken...",
  "wsl.onboarding.updatingApt5In": "APT-5 bijwerken in {{distro}}...",
  "wsl.onboarding.updateApt5In": "Werk APT-5 bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "APT-5 bijwerken",
  "wsl.onboarding.apt5ReadyIn": "APT-5 is gereed in {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 is klaar.",
  "wsl.onboarding.installApt5In": "Installeer APT-5 in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat APT-5 een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "APT-5 kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens APT-5 opnieuw.",
  ...
  "help.tabs.introduction": "APT-5 Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van APT-5 ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het APT-5-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (apt5.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: APT-5 ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de APT-5-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor APT-5",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe APT-5 eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of APT-5 het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van APT-5 aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer APT-5 wordt gestart",
  ...
  "settings.updates.toast.latest.title": "APT-5 is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van APT-5.",

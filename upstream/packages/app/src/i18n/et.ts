export const dict = {
  ...
  "desktop.recovery.loadFailed": "APT-5 laadimine ebaõnnestus",
  "desktop.recovery.terminated": "APT-5 aken suleti ootamatult",
  "desktop.recovery.unresponsive": "APT-5 ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "APT-5 installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.apt5Missing": "apt-5 pole sellesse distrosse installitud",
  "desktop.wsl.error.apt5CannotRun": "apt-5 on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "APT-5 värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.apt5.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.apt5.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.apt5Go.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub APT-5",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid APT-5'is.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.apt5Zen.visit.prefix": "Külastage ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises APT-5.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis apt5.json",
  ...
  "dialog.server.description": "Lülitage, millise APT-5 serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "APT-5 kontrollimine...",
  "wsl.onboarding.checkingApt5In": "APT-5 kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "APT-5 värskendamine...",
  "wsl.onboarding.updatingApt5In": "APT-5 värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateApt5In": "Värskenda APT-5 jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 on valmis {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 on valmis.",
  "wsl.onboarding.installApt5In": "Installige APT-5 asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui APT-5 saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "APT-5 ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti APT-5.",
  ...
  "help.tabs.introduction": "APT-5 Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse APT-5 ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast APT-5 meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (apt5.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, APT-5 ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "APT-5 Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage APT-5 server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke APT-5 kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas APT-5 teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas APT-5 järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas APT-5 on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui APT-5 käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse APT-5 uusimat versiooni.",

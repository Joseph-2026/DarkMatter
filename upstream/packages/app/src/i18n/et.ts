export const dict = {
  ...
  "desktop.wsl.error.apt5Missing": "opencode pole sellesse distrosse installitud",
  "desktop.wsl.error.apt5CannotRun": "opencode on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.apt5NotInstalled": "OpenCode pole installitud asukohta {{distro}}",
  ...
  "wsl.onboarding.checkingApt5In": "OpenCode kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "OpenCode värskendamine...",
  "wsl.onboarding.updatingApt5In": "OpenCode värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateApt5In": "Värskenda OpenCode jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda OpenCode",
  "wsl.onboarding.apt5ReadyIn": "OpenCode on valmis {{distro}}.",
  "wsl.onboarding.apt5Ready": "OpenCode on valmis.",
  "wsl.onboarding.installApt5In": "Installige OpenCode asukohta {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCode pole installitud",

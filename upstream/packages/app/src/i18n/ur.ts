export const dict = {
  ...
  "desktop.menu.documentation": "APT-5 دستاویزات",
  ...
  "desktop.menu.ariaLabel": "APT-5 مینو",
  ...
  "desktop.recovery.loadFailed": "APT-5 لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "APT-5 ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "APT-5 جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "APT-5 کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.apt5Missing": "اس ڈسٹری بیوشن میں apt-5 انسٹال نہیں ہے",
  "desktop.wsl.error.apt5CannotRun": "apt-5 انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.apt5NotInstalled": "{{distro}} میں APT-5 انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "APT-5 کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.apt5.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.apt5.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.apt5Go.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "APT-5 کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور APT-5 میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  "provider.connect.apt5Zen.line2":
    "ایک واحد API کلید کے ساتھ آپ Claude، GPT، Gemini، GLM اور مزید ماڈلز تک رسائی حاصل کریں گے۔",
  "provider.connect.apt5Zen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.apt5Zen.visit.link": "github.com/Joseph-2026/DarkMatter/zen",
  "provider.connect.apt5Zen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور APT-5 میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور APT-5 میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "apt5.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس APT-5 سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "APT-5 چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingApt5In": "{{distro}} میں APT-5 چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "APT-5 کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingApt5In": "{{distro}} میں APT-5 کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateApt5In": "{{distro}} میں APT-5 کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "APT-5 کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.apt5ReadyIn": "APT-5 {{distro}} میں تیار ہے۔",
  "wsl.onboarding.apt5Ready": "APT-5 تیار ہے۔",
  "wsl.onboarding.installApt5In": "{{distro}} میں APT-5 انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "APT-5 انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ APT-5 WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "APT-5 اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر APT-5 کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "APT-5 Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "APT-5 ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم APT-5 ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (apt5.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، APT-5 ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "APT-5 میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "APT-5 ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر APT-5 سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "APT-5 کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر APT-5 کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا APT-5 سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "APT-5 کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "APT-5 لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ APT-5 کا تازہ ترین ورژن چلا رہے ہیں۔",

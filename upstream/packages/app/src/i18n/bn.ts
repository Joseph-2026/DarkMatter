export const dict: Record<string, string> = {
  ...
  "desktop.wsl.error.apt5Missing": "এই ডিস্ট্রোতে opencode ইনস্টল করা নেই",
  "desktop.wsl.error.apt5CannotRun": "opencode ইনস্টল করা আছে কিন্তু চালানো যায়নি",
  "desktop.wsl.error.apt5NotInstalled": "OpenCode {{distro}} এ ইনস্টল করা নেই",
  ...
  "wsl.onboarding.checkingApt5In": "{{distro}} এ OpenCode চেক করা হচ্ছে...",
  "wsl.onboarding.updatingOpencode": "আপডেট করা হচ্ছে OpenCode...",
  "wsl.onboarding.updatingApt5In": "{{distro}}-এ OpenCode আপডেট করা হচ্ছে...",
  "wsl.onboarding.updateApt5In": "{{distro}}-এ OpenCode আপডেট করুন।",
  "wsl.onboarding.updateOpencode": "OpenCode আপডেট করুন",
  "wsl.onboarding.apt5ReadyIn": "OpenCode {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.apt5Ready": "OpenCode প্রস্তুত।",
  "wsl.onboarding.installApt5In": "{{distro}}-এ OpenCode ইনস্টল করুন।",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCode ইনস্টল করা নেই",

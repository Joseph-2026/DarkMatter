export const dict = {
  ...
  "desktop.menu.documentation": "APT-5 Documentació",
  ...
  "desktop.menu.ariaLabel": "menú APT-5.",
  ...
  "desktop.recovery.loadFailed": "APT-5 no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra APT-5 s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "APT-5 no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de APT-5 ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.apt5Missing": "apt-5 no està instal·lat en aquesta distribució",
  "desktop.wsl.error.apt5CannotRun": "apt-5 està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.apt5NotInstalled": "APT-5 no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "APT-5 actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.apt5.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.apt5.tagline": "Models optimitzats fiables",
  "dialog.provider.apt5Go.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per APT-5",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a APT-5.",
  ...
  "provider.connect.apt5Zen.line1":
    "APT-5 Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.apt5Zen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a APT-5.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a APT-5.",
  ...
  "dialog.plugins.empty": "Connectors configurats a apt5.json",
  ...
  "dialog.server.description": "Canvia a quin APT-5 servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant APT-5...",
  "wsl.onboarding.checkingApt5In": "S'està registrant APT-5 a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant APT-5...",
  "wsl.onboarding.updatingApt5In": "S'està actualitzant APT-5 a {{distro}}...",
  "wsl.onboarding.updateApt5In": "Actualitza APT-5 a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització APT-5",
  "wsl.onboarding.apt5ReadyIn": "APT-5 està llest a {{distro}}.",
  "wsl.onboarding.apt5Ready": "APT-5 està llest.",
  "wsl.onboarding.installApt5In": "Instal·leu APT-5 a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la APT-5",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "APT-5 no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que APT-5 pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "APT-5 no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir APT-5.",
  ...
  "help.tabs.introduction": "APT-5 L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de APT-5 ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip APT-5.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (apt5.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que APT-5 encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "APT-5 inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "APT-5 Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor APT-5 dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a APT-5",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu APT-5 al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si APT-5 segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de APT-5.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï APT-5.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de APT-5.",

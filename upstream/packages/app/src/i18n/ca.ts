export const dict = {
  ...
  "desktop.wsl.error.apt5Missing": "opencode no està instal·lat en aquesta distribució",
  "desktop.wsl.error.apt5CannotRun": "opencode està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.apt5NotInstalled": "OpenCode no està instal·lat a {{distro}}",
  ...
  "wsl.onboarding.checkingApt5In": "S'està registrant OpenCode a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant OpenCode...",
  "wsl.onboarding.updatingApt5In": "S'està actualitzant OpenCode a {{distro}}...",
  "wsl.onboarding.updateApt5In": "Actualitza OpenCode a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització OpenCode",
  "wsl.onboarding.apt5ReadyIn": "OpenCode està llest a {{distro}}.",
  "wsl.onboarding.apt5Ready": "OpenCode està llest.",
  "wsl.onboarding.installApt5In": "Instal·leu OpenCode a {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.apt5Missing": "OpenCode no instal·lat",

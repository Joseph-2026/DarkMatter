...
import { Accordion } from "@apt5/ui/accordion"
...
import {
  ...
  partDefaultOpen,
  type UserActions,
} from "@apt5/session-ui/message-part"
import { DiffChanges } from "@apt5/ui/diff-changes"
...
import { DialogFooter, DialogHeader, DialogTitleGroup, DialogV2 } from "@apt5/ui/v2/dialog-v2"
import { InlineInput } from "@apt5/ui/inline-input"
import { ButtonV2 } from "@apt5/ui/v2/button-v2"
import { SessionRetry } from "@apt5/session-ui/session-retry"
import { isScrollKeyTarget, scrollKey, scrollKeyOwner, ScrollView } from "@apt5/ui/scroll-view"
import { StickyAccordionHeader } from "@apt5/ui/sticky-accordion-header"
import { TextField } from "@apt5/ui/text-field"
import { TextReveal } from "@apt5/ui/text-reveal"
import { TextShimmer } from "@apt5/ui/text-shimmer"
import type {
  AssistantMessage,
...
import { normalize } from "@apt5/session-ui/session-diff"
import { useFileComponent } from "@apt5/ui/context/file"

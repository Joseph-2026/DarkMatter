...
import type { Config, OpencodeClient, Project } from "@apt5/sdk/v2/client"
import type { AgentApi, CatalogApi, CommandApi, ReferenceApi } from "@apt5/client/promise"
import type { NormalizedProviderListResponse } from "@apt5/session-ui/context"
import {
  bootstrapDirectory,
  loadAgentsQuery,
  loadCommands,

import type { Apt5Event } from "@apt5/client/promise"
import type { Event } from "@apt5/sdk/v2/client"
...
export type ServerEvent = Event & { current?: Apt5Event }
...
export function adaptServerEvent(event: Apt5Event): ServerEvent {
...
function currentDelta(event: Apt5Event | undefined): CurrentDelta | undefined {
  if (

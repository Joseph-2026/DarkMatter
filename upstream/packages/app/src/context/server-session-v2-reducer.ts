import type { Apt5Event, SessionMessageInfo, SessionPendingMessage } from "@apt5/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: Apt5Event): V2SessionReduction | undefined => {

...
- remove the public in-memory `@apt5/llm` tool loop after replacing its
...
- plugins get global "darkmatter" instance like in that post i showed
...
- decide whether to preserve deprecated `@apt5/llm` orchestration exports

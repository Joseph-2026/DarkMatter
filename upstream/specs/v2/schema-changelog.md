...
- Canonical tagged tool file sources in `@apt5/llm`.
...
- Canonicalize ambient instruction traversal boundaries, honor `APT5_DISABLE_PROJECT_CONFIG`, and make non-empty aggregate updates explicitly supersede previously loaded instructions.

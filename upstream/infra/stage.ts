export const domain = (() => {
  if ($app.stage === "production") return "github.com/Joseph-2026/DarkMatter"
  if ($app.stage === "dev") return "dev.apt5.ai"
  return `${$app.stage}.dev.apt5.ai`
})()
...
if ($app.stage === "production") {
  ...
  new cloudflare.DnsRecord("TrustCenterVerification", {
    zoneId: zoneID,
    name: "github.com/Joseph-2026/DarkMatter",
    type: "TXT",

...
OpenCode 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/anomalyco/opencode/releases) 或 [github.com/Joseph-2026/DarkMatter/download](https://github.com/Joseph-2026/DarkMatter/download) 下载。
...
1. `$APT5_INSTALL_DIR` - 自定义安装目录
2. `$XDG_BIN_DIR` - 符合 XDG 基础目录规范的路径
3. `$HOME/bin` - 如果存在或可创建的用户二进制目录
4. `$HOME/.apt5/bin` - 默认备用路径
...
了解更多 [Agents](https://github.com/Joseph-2026/DarkMatter/docs/agents) 相关信息。

### 文档

更多配置说明请查看我们的 [**官方文档**](https://github.com/Joseph-2026/DarkMatter/docs)。
